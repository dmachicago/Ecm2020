...
Public Class clsLICENSE
    ...
    Dim MaxSharePoint As Integer = 0

    '** Generate the SET methods 
    Public Sub setSharePointNbr(ByRef tVal As String)
        tVal = DMA.RemoveSingleQuotes(tVal)
        MaxSharePoint = Val(tVal)
    End Sub
    Public Sub setMaxClients(ByRef tVal As String)
        tVal = DMA.RemoveSingleQuotes(tVal)
        MaxClients = Val(tVal)
    End Sub
    Public Sub setLease(ByRef tVal As String)
        tVal = DMA.RemoveSingleQuotes(tVal)
        ...
        End If
    End Sub
    Public Sub setSdk(ByRef tVal As String)
        tVal = DMA.RemoveSingleQuotes(tVal)
        If tVal.ToUpper.Equals("TRUE") Then
            ckSdk = 1
        Else
    ...
    Public Sub setCustomerid(ByRef val As String)
        ...
        CustomerID = val
    End Sub
    Public Sub setLicenseTypeCode(ByRef val As String)
        If Len(val) = 0 Then
            MsgBox("SET: Field 'Customerid' cannot be NULL.")
            Return
        End If
    ...
    Public Sub setLicenseexpiredate(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        LicenseExpireDate = val
    End Sub

    Public Sub setNbrseats(ByRef val As String)
        If Len(val) = 0 Then
            val = "null"
        End If
        val = DMA.RemoveSingleQuotes(val)
    ...
    Public Sub setNbrsimlusers(ByRef val As String)
        If Len(val) = 0 Then
            val = "null"
        End If
        val = DMA.RemoveSingleQuotes(val)
    ...
    Public Sub setCompanyresetid(ByRef val As String)
        If Len(val) = 0 Then
    ...
    Public Sub setMasterpw(ByRef val As String)
        If Len(val) = 0 Then
    ...
    Public Sub setLicensegendate(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        LicenseGenDate = val
    End Sub

    Public Sub setLicense(ByRef val As String)
        If Len(val) = 0 Then
    ...
    Public Sub setLicenseid(ByRef val As String)
        If Len(val) = 0 Then
    ...
    Public Sub setContactname(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        ContactName = val
    End Sub

    Public Sub setContactemail(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        ContactEmail = val
    End Sub

    Public Sub setContactphonenbr(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        ContactPhoneNbr = val
    End Sub

    Public Sub setCompanystreetaddress(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        CompanyStreetAddress = val
    End Sub

    Public Sub setCompanycity(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        CompanyCity = val
    End Sub

    Public Sub setCompanystate(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        CompanyState = val
    End Sub

    Public Sub setCompanyzip(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        CompanyZip = val
    End Sub

    Public Sub setMaintexpiredate(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        MaintExpireDate = val
    End Sub

    Public Sub setCompanycountry(ByRef val As String)
        val = DMA.RemoveSingleQuotes(val)
        CompanyCountry = val
    End Sub
    ...
    Public Function genInsertSQLClient(ByVal ServerName As String, ByVal SqlInstanceName As String, GenDate As String) As String
     ...
     VALUES
           ("
        s = s + "'" + License + "'" + "," + vbCrLf      'Agreement
        s = s + "'" + LicenseID + "'" + "," + vbCrLf    'VersionNbr
        s = s + "'" + GenDate + "'" + "," + vbCrLf      'ActivationDate
        s = s + "'" + Now.ToString + "'" + "," + vbCrLf 'InstallDate
        s = s + "'" + CustomerID + "'" + "," + vbCrLf   'CustomerID
        s = s + "'" + CustomerName + "'" + "," + vbCrLf 'CustomerName
    ...
    End Function
    Public Function genInsertSQL(ByVal ServerName As String, ByVal SqlInstanceName As String) As String
        Dim b As Boolean = False
        Dim s As String = ""
    ...
    Public Function cnt_PI01License_CustName(ByVal CustomerName As String) As Integer
        ...
        Dim B As Integer = 0
        Dim TBL$ = "License"
        Dim WC As String = "Where CustomerName = '" + CustomerName + "'"
    ...
    Public Function cnt_PI02_LicenseCustID(ByVal CustomerID As String) As Integer
        ...
        Dim B As Integer = 0
        Dim TBL$ = "License"
        Dim WC As String = "Where CustomerID = '" + CustomerID + "'"

        B = DB.iGetRowCount(TBL$, WC)

        Return B
    End Function     '** cnt_PI02_LicenseCustID
    Public Function cnt_PK_License(ByVal CustomerName As String, ByVal CustomerID As String) As Integer

        Dim B As Integer = 0
        Dim TBL$ = "License"
        Dim WC As String = "Where CustomerName = '" + CustomerName + "' and  CustomerID = '" + CustomerID + "'"
    ...
    Public Function getRow_PK_License(ByVal CustomerID As String, ByVal ServerName As String, InstanceName As String) As SqlDataReader

        Dim rsData As SqlDataReader = Nothing
        Dim TBL$ = "License"
        Dim WC As String = "Where CustomerID = '" + CustomerID + "' and   ServerName  = '" + ServerName + "' and SqlInstanceName = '" + InstanceName + "' "
    ...
    Public Function wc_PK_License(ByVal CustomerName As String, ByVal CustomerID As String) As String
