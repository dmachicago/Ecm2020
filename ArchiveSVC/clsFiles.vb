...
Public Class clsFiles
    ...
    Public Function UploadRemoteFile(ByVal msgRequest As RemoteFileUploadMsg) As String
        ...
        Dim result As New RemoteFileUploadMsg

        Dim tgtGuid As String = msgRequest.FileGuid
        Dim FileLength As Long = msgRequest.FileLength
        Dim FileName As String = msgRequest.FileName
        Dim RepositoryTable As String = msgRequest.FileType.ToUpper
        Dim CRC As String = msgRequest.FileCrc
        Dim fStream As Stream = msgRequest.data
        Dim UID As String = msgRequest.UID
        ...
        Try
            ...
            While (count > 0)
                ...
                count = msgRequest.data.Read(buffer, 0, bufferLen)
            End While
            outstream.Close()
            msgRequest.data.Close()
            bLoadFileToDB = True
