...
Public Class clsEncrypt
    ...
    Public Function hashSha1File(ByVal FQN) As String
    ...
    Private Function byteIV() As Byte()
    ...
    Public Function DecryptTripleDES(ByVal sOut As String, ByRef RC As Boolean, ByRef RetMsg As String) As String
        If sOut.Length = 0 Then
            Return ""
        End If
        Dim sKey As String = bKey()
        ...
        Dim S As String
        Try
            S = System.Text.ASCIIEncoding.ASCII.GetString(DESDecrypt.TransformFinalBlock(Buffer, 0, Buffer.Length))
    ...
    Public Function xt001trc(ByVal S As String, ByRef RC As Boolean, ByRef RetMsg As String) As SortedList(Of String, String)
        ...
        SS = DecryptTripleDES128(S, B, RC, RetMsg)
        Dim AR$() = Split(SS, "|")
        ...
        For i As Integer = 1 To UBound(AR)
            ...
            If i Mod 2 = 0 Then
                ...
                Catch ex As Exception
                    ...
                    RetMsg = ("clsEncrypt : xt001trc : 104 : " + ex.Message)
                    RC = False
                End Try
    ...
    Public Function DecryptTripleDES128(ByVal sOut As String, ByRef B As Boolean, ByRef RC As Boolean, ByRef RetMsg As String) As String
        Dim S As String = ""
        Try
            ...
            S = System.Text.ASCIIEncoding.ASCII.GetString(DESDecrypt.TransformFinalBlock(Buffer, 0, Buffer.Length))
        Catch ex As Exception
            RetMsg = ("clsEncrypt : DecryptTripleDES : 141 : " + ex.Message)
            Return ""
        End Try
        Return S
    End Function
