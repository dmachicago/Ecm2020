...
namespace ConsoleArchiver
{
    ...
    class clsEncrypt
    {
        ...
        public string DecryptTripleDES(string sOut)
        {
            ...
            {
                LOG.write(traceon, "DecryptTripleDES - Error in decrypting string.");
        ...
        public string DecryptTripleDES128(string sOut, bool B)
        {
            ...
            {
                LOG.write (traceon,"clsEncrypt : DecryptTripleDES : 141 : " + ex.Message);
                return "";
            }
        }
        ...
        public string EncryptString128Bit(string vstrTextToBeEncrypted, string vstrEncryptionKey)
        {
            ...
            {
                LOG.write (traceon,"ERROR: IntegrityCheck E: " + ex.Message);
                return null;
            }
        }
        ...
        public string hashMd5(string filePath)
        {
            ...
            {
                LOG.write (traceon,"ERROR: IntegrityCheck C: " + ex.Message);
            }
            catch (UnauthorizedAccessException ex)
            {
                LOG.write (traceon,"ERROR: IntegrityCheck D: " + ex.Message);
            }
            finally
            {
                if (fs != null)
        ...
        public string hashSha1(string filePath)
        {
            ...
            {
                LOG.write (traceon,"ERROR: IntegrityCheck A: " + ex.Message);
            }
            catch (UnauthorizedAccessException ex)
            {
                LOG.write (traceon,"ERROR: IntegrityCheck B: " + ex.Message);
            }
            finally
            {
                if (fs != null)
            ...
            for (int i = 1; i <= (AR.Length - 1); i++)
            {
                ...
                if (i % 2 == 0)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        LOG.write (traceon,"clsEncrypt : xt001trc : 104 : " + ex.Message);
                    }
