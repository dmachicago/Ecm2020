...
Public Class clsEncrypt
    ...
    Public Sub saveString(action As String, s As String)
    ...
    Public Shared Function xDecryptTripleDES(ByVal sOut As String, ByVal sKey As String) As String
        Dim DES As New System.Security.Cryptography.TripleDESCryptoServiceProvider
        Dim hashMD5 As New System.Security.Cryptography.MD5CryptoServiceProvider
    ...
    Public Function xDecryptTripleDES(ByVal sOut As String) As String
        Dim sKey$ = bKey()
        Dim DES As New System.Security.Cryptography.TripleDESCryptoServiceProvider
        Dim hashMD5 As New System.Security.Cryptography.MD5CryptoServiceProvider
