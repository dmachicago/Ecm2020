...
/***********************************************************************************************************
		Copyright © 2001 DMA Limited . All rights reserved.
...
Written by:	W. dale Miller
			http:\\www.DmaChicago.com

Tested on: 	SQL Server 7.0, SQL Server 2000

Date modified:	December-25-2001 01:00 AM IST
		(I am Jewish, so I can work on Christmas no problem)

Email: 		dm@DmaChicago.com

Usage:		Run this script in the master database to create the stored procedure. Once it is created,
		you can run it from any of your user databases. If the first parameter (database name) is
