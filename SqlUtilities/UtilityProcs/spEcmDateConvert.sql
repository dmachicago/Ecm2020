alter FUNCTION spEcmDateConvert
(
	@Date datetime,
	@fORMAT VARCHAR(80)
)
...
END
GO
SELECT dbo.spEcmDateConvert ('8/7/2008', 'mm/dd/yy')
GO
SELECT dbo.spEcmDateConvert ('8/7/2008', 'hh:mm:ss')
GO
SELECT dbo.spEcmDateConvert ('8/7/2008', 'mmm')
GO
SELECT dbo.spEcmDateConvert ('8/7/2008', 'Mmm dd yyyy hh:mm:ss:ms AM/PM')
GO
SELECT dbo.spEcmDateConvert ('8/7/2008', '#')
GO
