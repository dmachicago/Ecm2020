...
/****** Object:  StoredProcedure [dbo].[Proc_EDW_TrackerMetadataExtract]    Script Date: 8/11/2014 2:44:29 PM ******/
SET ANSI_NULLS ON
GO
...
alter procedure [dbo].[Proc_EDW_TrackerMetadataExtract] (@TrackerClassName as nvarchar(250))
as
IF EXISTS
	(
		SELECT name
