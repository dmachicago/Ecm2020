--Select DocumentID, * from view_CMS_TREE_JOINED as TJ
--where NodeGuid = 'FE226D76-D14F-4D7E-8856-2DD4AB5D1BF4'
...
SELECT 
		...
		, HA.DocumentGuid as HADocumentGUID		--, HA.DocumentID AS HADocumentID	--WDM 08.07.2014
		...
		, VHFHAMJ.DocumentGuid as ModDocGUID	--, VHFHAMJ.DocumentID AS ModDocID
		...
		, VHFHARCJ.DocumentGUID AS RCDocumentGUID	--, VHFHARCJ.DocumentID AS RCDocumentID
		...
		, VHFHARAJ.DocumentGuid AS RADocumentGUID	--, VHFHARAJ.DocumentID AS RADocumentID
		...
		, VHFHAQ.DocumentGuid as QuesDocumentGUID		--, VHFHAQ.DocumentID AS QuesDocumentID
		...
		, VHFHAA.DocumentGuid AS AnsDocumentGUID		--, VHFHAA.DocumentID AS AnsDocumentID		
		...
		, VCTJ.NodeGuid as CMS_TREE_NodeGuid	--WDM 08.07.2014
	 FROM
