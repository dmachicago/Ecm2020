...
GO
PRINT 'Processing: view_EDW_RewardUserDetail_TEST_V2 ';
GO

IF EXISTS (SELECT
                  NAME
                  FROM sys.VIEWS
                  WHERE NAME = 'view_EDW_RewardUserDetail_TEST_V2') 
    BEGIN
        DROP VIEW
             view_EDW_RewardUserDetail_TEST_V2;
    END;
GO
-- select count(*) from view_EDW_RewardUserDetail_TEST_V2 --334654
CREATE VIEW dbo.view_EDW_RewardUserDetail_TEST_V2
AS

--**************************************************************************************************************************************************
--select * from [view_EDW_RewardUserDetail_TEST_V2] where ItemModifiedWhen between '2000-11-14' and '2014-11-15'
--select * from [view_EDW_RewardUserDetail_TEST_V2] where ItemModifiedWhen between '2014-05-12' and '2014-05-13' 
...
GO
PRINT 'Completed : view_EDW_RewardUserDetail_TEST_V2 ';
GO
...
PRINT '***** FROM: view_EDW_RewardUserDetail_TEST_V2.sql';
GO 
