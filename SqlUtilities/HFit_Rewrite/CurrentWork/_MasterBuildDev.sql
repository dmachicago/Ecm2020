...
where VHFHAMCQJ.DocumentCulture = 'en-US'   --(WDM) 09.19.2014 added to filter at this level of nesting
...
where VHFHAMQJ.DocumentCulture = 'en-US'   --(WDM) 09.19.2014 added to filter at this level of nesting
...
where VHFHAFFJ.DocumentCulture = 'en-US'   --(WDM) 09.19.2014 added to filter at this level of nesting
...
print ('Processing complete - please check for errors.' );  --  
  --  
GO 
print('***** FROM: _MasterBuildDev.sql'); 
GO 
