...
GO
-- select * from view_EDW_RewardsDefinition
IF EXISTS (SELECT
				  NAME
				  FROM sys.VIEWS
				  WHERE NAME = 'view_EDW_RewardsDefinition') 
	BEGIN
		  print 'Replacing view view_EDW_RewardsDefinition';
		DROP VIEW
...
-- 07.15.2015 Corina and Dale reviewed and worked on the view DDL with corrections suggested by Corina (per SR-54809)
-- 10.19.2015 Corina, Scott, and Dale corrected the view to give Corina what she wanted and publisdhed it to the lowers (per SR-54809).
-- 10.26.2015 Mods to this view passed to Ejaz for application tomorrow evening (SR-54809)
--****************************************************************************************************************************************************
	 ...
	 --, GroupHeadingDescription
	   FROM dbo.View_EDW_RewardProgram_Joined AS VHFRPJ
				INNER JOIN dbo.View_HFit_RewardGroup_Joined AS VHFRGJ
				 ...
				 -- per SR-54809 10.19.2015 WDM and Corina
