...
IF EXISTS (SELECT
                  ...
                  FROM sys.views
                  WHERE
                  name = 'view_EDW_HealthAssesment_CT') 
    BEGIN
        DROP VIEW
...
--, change_tracking_is_column_in_mask (COLUMNPROPERTY (OBJECT_ID ('CMS_UserSite') , 'UserPreferredCurrencyID', 'columnid') , CTE.sys_change_columns) AS [UserPreferredCurrencyID_cg] 
       ...
       USERSETTINGS.HFITUSERMPINUMBER >= 0 AND
       USERSETTINGS.HFITUSERMPINUMBER IS NOT NULL AND
       USERSETTINGS.SVR = CMSUSER.SVR AND
       USERSETTINGS.DBNAME = CMSUSER.DBNAME
       ...
       VHCJ.DOCUMENTCULTURE = 'en-US' AND
       VHCJ.SVR = USERSITE.SVR AND
       VHCJ.DBNAME = USERSITE.DBNAME
       ...
       HAUSERQUESTION.DBNAME = HAQUESTIONSVIEW.DBNAME
       ...
       HAUSERQUESTION.DBNAME = HAUSERANSWERS.DBNAME
                 ...
                 ON
       USERSETTINGS.USERSETTINGSID = CT_CMS_USERSETTINGS.USERSETTINGSID AND
       USERSETTINGS.SVR = CT_CMS_USERSETTINGS.SVR AND
       USERSETTINGS.DBNAME = CT_CMS_USERSETTINGS.DBNAME
                 LEFT JOIN CHANGETABLE (CHANGES DBO.BASE_CMS_USER , NULL) AS CT_CMS_USER
                 ON
       CMSUSER.USERID = CT_CMS_USER.USERID AND
       CMSUSER.SVR = CT_CMS_USER.SVR AND
       CMSUSER.DBNAME = CT_CMS_USER.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_CMS_SITE , NULL) AS CT_CMS_SITE
                 ON
       CMSSITE.SITEID = CT_CMS_SITE.SITEID AND
       CMSSITE.SVR = CT_CMS_SITE.SVR AND
       CMSSITE.DBNAME = CT_CMS_SITE.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_CMS_USERSITE , NULL) AS CT_CMS_USERSITE
                 ON
       USERSITE.USERSITEID = CT_CMS_USERSITE.USERSITEID AND
       USERSITE.SVR = CT_CMS_USERSITE.SVR AND
       USERSITE.DBNAME = CT_CMS_USERSITE.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_HFIT_ACCOUNT , NULL) AS CT_HFIT_ACCOUNT
                 ON
       ACCT.ACCOUNTID = CT_HFIT_ACCOUNT.ACCOUNTID AND
       ACCT.SVR = CT_HFIT_ACCOUNT.SVR AND
       ACCT.DBNAME = CT_HFIT_ACCOUNT.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_HFIT_HACAMPAIGN , NULL) AS CT_HFIT_HACAMPAIGN
                 ON
       VHCJ.HACAMPAIGNID = CT_HFIT_HACAMPAIGN.HACAMPAIGNID AND
       VHCJ.SVR = CT_HFIT_HACAMPAIGN.SVR AND
       VHCJ.DBNAME = CT_HFIT_HACAMPAIGN.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_HFIT_HEALTHASSESMENTUSERANSWERS , NULL) AS CT_HFIT_HEALTHASSESMENTUSERANSWERS
                 ON
       HAUSERANSWERS.ITEMID = CT_HFIT_HEALTHASSESMENTUSERANSWERS.ITEMID AND
       HAUSERANSWERS.SVR = CT_HFIT_HEALTHASSESMENTUSERANSWERS.SVR AND
       HAUSERANSWERS.DBNAME = CT_HFIT_HEALTHASSESMENTUSERANSWERS.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_HFIT_HEALTHASSESMENTUSERMODULE , NULL) AS CT_HFIT_HEALTHASSESMENTUSERMODULE
                 ON
       HAUSERMODULE.ITEMID = CT_HFIT_HEALTHASSESMENTUSERMODULE.ITEMID AND
       HAUSERMODULE.SVR = CT_HFIT_HEALTHASSESMENTUSERMODULE.SVR AND
       HAUSERMODULE.DBNAME = CT_HFIT_HEALTHASSESMENTUSERMODULE.DBNAME
                 ...
                 ON
       HAUSERQUESTION.ITEMID = CT_HFIT_HEALTHASSESMENTUSERQUESTION.ITEMID AND
       HAUSERQUESTION.SVR = CT_HFIT_HEALTHASSESMENTUSERQUESTION.SVR AND
       HAUSERQUESTION.DBNAME = CT_HFIT_HEALTHASSESMENTUSERQUESTION.DBNAME
                 ...
                 ON
       HAUSERQUESTIONGROUPRESULTS.ITEMID = CT_HFIT_HEALTHASSESMENTUSERQUESTIONGROUPRESULTS.ITEMID AND
       HAUSERQUESTIONGROUPRESULTS.SVR = CT_HFIT_HEALTHASSESMENTUSERQUESTIONGROUPRESULTS.SVR AND
       HAUSERQUESTIONGROUPRESULTS.DBNAME = CT_HFIT_HEALTHASSESMENTUSERQUESTIONGROUPRESULTS.DBNAME
                 ...
                 ON
       HAUSERRISKAREA.ITEMID = CT_HFIT_HEALTHASSESMENTUSERRISKAREA.ITEMID AND
       HAUSERRISKAREA.SVR = CT_HFIT_HEALTHASSESMENTUSERRISKAREA.SVR AND
       HAUSERRISKAREA.DBNAME = CT_HFIT_HEALTHASSESMENTUSERRISKAREA.DBNAME
                 ...
                 ON
       HARISKCATEGORY.ITEMID = CT_HFIT_HEALTHASSESMENTUSERRISKCATEGORY.ITEMID AND
       HARISKCATEGORY.SVR = CT_HFIT_HEALTHASSESMENTUSERRISKCATEGORY.SVR AND
       HARISKCATEGORY.DBNAME = CT_HFIT_HEALTHASSESMENTUSERRISKCATEGORY.DBNAME
                 LEFT OUTER JOIN CHANGETABLE (CHANGES DBO.BASE_HFIT_HEALTHASSESMENTUSERSTARTED , NULL) AS CT_HFIT_HEALTHASSESMENTUSERSTARTED
                 ON
       HAUSERSTARTED.ITEMID = CT_HFIT_HEALTHASSESMENTUSERSTARTED.ITEMID AND
       HAUSERSTARTED.SVR = CT_HFIT_HEALTHASSESMENTUSERSTARTED.SVR AND
       HAUSERSTARTED.DBNAME = CT_HFIT_HEALTHASSESMENTUSERSTARTED.DBNAME
