...
GO
PRINT 'Creating proc_genFactUpdtTrigger';
GO
IF EXISTS ( SELECT
                   name
                   FROM sys.procedures
                   WHERE name = 'proc_genFactUpdtTrigger') 
    BEGIN
        DROP PROCEDURE
             proc_genFactUpdtTrigger;
    END;
GO

/*
declare @DDL as nvarchar(max) = '' ;
exec proc_genFactUpdtTrigger 'FACT_CMS_User', @DDL
declare @S as nvarchar(max) = '' ;
set @S = @DDL ;
print @S ;
*/

CREATE PROCEDURE proc_genFactUpdtTrigger (
...
END;
GO
PRINT 'Created proc_genFactUpdtTrigger';
GO
