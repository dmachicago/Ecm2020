        ...
        , NULL AS ChangeType
          FROM DBO.FACT_EDW_HFIT_HEALTHASSESMENTUSERSTARTED AS HAUserStarted
                   ...
                   INNER JOIN DBO.FACT_EDW_HFIT_HealthAssesmentUserAnswers AS HAUSERANSWERS
                      ...
                      AND HAUSERQUESTION.DBNAME = HAUSERANSWERS.DBNAME --INNER JOIN dbo.FACT_EDW_PkHashkey AS HKEY
                   INNER JOIN dbo.LKUP_NewEdwHAHashkeys AS HKEY
                       ON HKEY.HAUSERSTARTED_ITEMID = HAUserStarted.ITEMID
                      AND HKEY.SVR = HAUserStarted.SVR
                      AND HKEY.DBNAME = HAUserStarted.DBNAME
