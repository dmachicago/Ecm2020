...
GO
PRINT 'Creating proc_genFactInsTrigger';
GO
IF EXISTS ( SELECT
                   name
                   FROM sys.procedures
                   WHERE name = 'proc_genFactInsTrigger') 
    BEGIN
        DROP PROCEDURE
             proc_genFactInsTrigger;
    END;
GO

/*
declare @DDL as nvarchar(max) = '' ;
exec proc_genFactInsTrigger 'BASE_MART_EDW_HealthAssesment', @DDL
declare @S as nvarchar(max) = '' ;
set @S = @DDL ;
print @S ;
*/

CREATE PROCEDURE proc_genFactInsTrigger (
...
END;
GO
PRINT 'Created proc_genFactInsTrigger';
GO
