...
/****** Object:  View [dbo].[View_HFit_HealthAssessment_Joined]    Script Date: 11/23/2015 12:35:19 PM ******/
DROP VIEW
     dbo.View_HFit_HealthAssessment_Joined;
GO
...
CREATE VIEW dbo.View_HFit_HealthAssessment_Joined
AS SELECT
          VJ.[Published]
      ,VJ.[SiteName]
      ,VJ.[ClassName]
      ...
      ,FT.[DBNAME]
          FROM View_CMS_Tree_Joined as VJ
                   INNER JOIN dbo.BASE_HFit_HealthAssessment as FT
                       ON VJ.DocumentForeignKeyValue = FT.HealthAssessmentID
				and VJ.SVR = FT.SVR
