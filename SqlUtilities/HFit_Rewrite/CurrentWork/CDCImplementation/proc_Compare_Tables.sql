...
GO
PRINT 'Processing proc_Compare_Tables';
GO
IF EXISTS (SELECT name
             FROM sys.procedures
             WHERE name = 'proc_Compare_Tables') 
    BEGIN
        PRINT 'Updating proc_Compare_Tables';
        DROP PROCEDURE proc_Compare_Tables;
    END;
GO
...
CREATE PROCEDURE proc_Compare_Tables (@LinkedSVR AS nvarchar (254) 
...
END;
GO
PRINT 'Created proc_Compare_Tables';
GO
