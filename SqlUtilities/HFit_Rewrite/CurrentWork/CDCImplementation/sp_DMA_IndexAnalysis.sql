...
IF OBJECT_ID('dbo.sp_DMA_IndexAnalysis') IS NOT NULL
    DROP PROCEDURE dbo.sp_DMA_IndexAnalysis
GO

/********************************************************************************************* 
Index Analysis Script v2.10 (C) 2005, Dale Miller

Feedback:
    mailto:wdalemiller@gmail.com 
    http://www.wdalemiller.com

License: 
   This query is free to use for personal, educational, and internal 
...
exec master..sp_DMA_IndexAnalysis 'CMS_User'
*********************************************************************************************/ 
CREATE PROCEDURE dbo.sp_DMA_IndexAnalysis
    (
