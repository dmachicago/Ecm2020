...
--update BASE_OM_ContactGroupMember set hashcode = 'xxx' where ContactGroupMemberID in
--(select top 100 ContactGroupMemberID from BASE_OM_ContactGroupMember)
...
--************************************************************
--Find the NEW Records   201236153  201607794  KenticoCMS_3
--select * from BASE_OM_ContactGroupMember where ContactGroupMemberID in (201236153 , 201607794)
--************************************************************
WITH CTE_NEW (DBNAME
            , ContactGroupMemberID) 
    AS (SELECT DBNAME
