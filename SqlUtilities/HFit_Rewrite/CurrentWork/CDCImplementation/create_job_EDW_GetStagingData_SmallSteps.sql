...
go
PRINT 'Creating JOB job_EDW_GetStagingData_SmallSteps' ;
GO
...
DECLARE
   @JNAME AS nvarchar (100) = 'job_EDW_GetStagingData_SmallSteps_' + @TGTDB;
...
/****** Object:  Step [Load_EDW_SmallSteps]    Script Date: 4/12/2015 9:59:37 AM ******/

EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, @step_name = N'Load_EDW_SmallSteps',
@step_id = 1,
...
@command = N'exec proc_EDW_SmallSteps',
@database_name = @TGTDB,
@flags = 0;
IF @@ERROR <> 0
OR @ReturnCode <> 0
