...
SELECT  
    ...
    , SS.DBNAME
	  FROM
           dbo.BASE_Hfit_SmallStepResponses AS SS
               JOIN BASE_HFit_HealthAssesmentUserStarted AS HAUS
                 ...
                 JOIN BASE_CMS_UserSite AS USERSITE
                   ON USERSITE.UserID = SS.UserID
                 JOIN BASE_CMS_Site AS CMSSITE
                 ...
                 JOIN BASE_HFit_ToDoSmallSteps AS TODO
                   ON SS.OutComeMessageGUID = TODO.OutComeMessageGUID
                 JOIN BASE_CMS_UserSettings AS CMS_US
                   ON CMS_US.UserSettingsUserID = SS.UserID
                  AND CMS_US.HFitUserMPINumber > 0
                  AND CMS_US.HFitUserMPINumber IS NOT NULL

           /*********************************************/
			 LEFT JOIN CHANGETABLE (CHANGES BASE_Hfit_SmallStepResponses, NULL) AS CT_Hfit_SmallStepResponses
                 ...
                 LEFT OUTER JOIN CHANGETABLE (CHANGES BASE_HFit_HealthAssesmentUserStarted, NULL) AS CT_HFit_HealthAssesmentUserStarted
                   ON HAUS.ItemID = CT_HFit_HealthAssesmentUserStarted.ItemID
                 LEFT OUTER JOIN CHANGETABLE (CHANGES BASE_HFit_OutComeMessages, NULL) AS CT_HFit_OutComeMessages
                 ...
                 LEFT OUTER JOIN CHANGETABLE (CHANGES BASE_HFit_ToDoSmallSteps, NULL) AS CT_HFit_ToDoSmallSteps
