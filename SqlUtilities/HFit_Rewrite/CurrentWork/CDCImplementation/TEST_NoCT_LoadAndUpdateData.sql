...
DECLARE @newtime AS datetime = GETDATE () ;
--Find NEW records
--***************************************************************************************
WITH CTE_EDW (
...
--SELECT COUNT(*) FROM ##EdwHAHashkeys
DECLARE @deltime AS datetime = GETDATE () ;
...
DECLARE @updtetime AS datetime = GETDATE () ;
--Find UPDATES
--***************************************************************************************
UPDATE S
       SET
