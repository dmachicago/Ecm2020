...
GO
PRINT 'Executing proc_SaveCurrCTVersionNbr.SQL';
GO
IF EXISTS (SELECT
                  name
                  FROM sys.procedures
                  WHERE name = 'proc_SaveCurrCTVersionNbr') 
    BEGIN
        DROP PROCEDURE
             proc_SaveCurrCTVersionNbr;
    END;
GO
...
-- exec proc_SaveCurrCTVersionNbr 'XXXX', 'CMS_User', 12
CREATE PROCEDURE proc_SaveCurrCTVersionNbr (
...
END;
GO
PRINT 'Executed proc_SaveCurrCTVersionNbr.SQL';
GO
