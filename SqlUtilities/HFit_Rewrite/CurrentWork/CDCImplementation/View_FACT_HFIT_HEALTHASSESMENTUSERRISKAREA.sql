...
GO
PRINT 'Executing VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA.SQL';
GO

IF EXISTS (SELECT
                  table_name
                  FROM information_schema.tables where table_name = 'VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA'
                  ) 
    BEGIN
    print 'Dropping view VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA '; 
        DROP VIEW
             VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA
    END;

GO

CREATE VIEW VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA
AS SELECT
   ...
   --into FACT_EDW_HFit_HealthAssesmentUserRiskArea_Joined
          FROM DBO.BASE_HFIT_HEALTHASSESMENTUSERRISKAREA AS HAUSERRISKAREA
...
GO
PRINT 'ExecutED VIEW_BASE_HFIT_HEALTHASSESMENTUSERRISKAREA.SQL';
GO
