...
--***********************************************************************************
	SELECT
       ...
       --,VCTJ.NodeAliasPath AS HANodeAliasPath
		...
		, NULL as IntroText -- dbo.udf_StripHTML(VHFHAMJ.IntroText) AS IntroText
       ...
       --,VHFHARAJ.NodeAliasPath AS RANodeAliasPath
		...
		, VHFHAQ.QuestionType
		, NULL AS QuesTitle --dbo.udf_StripHTML(VHFHAQ.Title) AS QuesTitle
...
--WDM Retrieve Matrix Level 1 Question Group
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL AS QuesTitle --dbo.udf_StripHTML(VHFHAQ2.Title) AS QuesTitle
		, VHFHAQ2.Weight
		, VHFHAQ2.IsRequired
		, VHFHAQ2.NodeID
		, VHFHAQ2.IsEnabled
...
--WDM Retrieve Branching Level 1 Question and Matrix Level 1 Question Group
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ3.Title) AS QuesTitle
		, VHFHAQ3.Weight
		, VHFHAQ3.IsRequired
		, VHFHAQ3.NodeID
		, VHFHAQ3.IsEnabled
...
--WDM Retrieve Branching Level 1 Question and Matrix Level 2 Question Group
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, null as QuesTitle --dbo.udf_StripHTML(VHFHAQ7.Title) AS QuesTitle
		, VHFHAQ7.Weight
		, VHFHAQ7.IsRequired
		, VHFHAQ7.NodeID
		, VHFHAQ7.IsEnabled
...
UNION ALL
	...
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ8.Title) AS QuesTitle
		, VHFHAQ8.Weight
		, VHFHAQ8.IsRequired
		, VHFHAQ8.NodeID
		, VHFHAQ8.IsEnabled
...
UNION ALL
	...
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ4.Title) AS QuesTitle
		, VHFHAQ4.Weight
		, VHFHAQ4.IsRequired
		, VHFHAQ4.NodeID
		, VHFHAQ4.IsEnabled
...
--WDM 6/25/2014 Retrieve the Branching level 3 Question Group
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ5.Title) AS QuesTitle
		, VHFHAQ5.Weight
		, VHFHAQ5.IsRequired
		, VHFHAQ5.NodeID
		, VHFHAQ5.IsEnabled
...
--WDM 6/25/2014 Retrieve the Branching level 4 Question Group
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ6.Title) AS QuesTitle
		, VHFHAQ6.Weight
		, VHFHAQ6.IsRequired
		, VHFHAQ6.NodeID
		, VHFHAQ6.IsEnabled
...
UNION ALL
	...
	SELECT
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, NULL as QuesTitle  --dbo.udf_StripHTML(VHFHAQ9.Title) AS QuesTitle
		, VHFHAQ9.Weight
		, VHFHAQ9.IsRequired
		, VHFHAQ9.NodeID
		, VHFHAQ9.IsEnabled
...
GO
  ...
  --  
GO 
print('***** FROM: view_EDW_HealthAssesmentDeffinitionV3.sql'); 
GO 
