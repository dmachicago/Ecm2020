...
GO
--drop table [BASE_EDW_BiometricViewRejectCriteria]
...
FROM
     dbo.BASE_HFit_UserTracker AS HFUT
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       hfut.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
...
WHERE
      ...
      HFA.AccountCD NOT IN (SELECT
                            ...
                            WHERE
                                   ...
                                   HFUT.ItemCreatedWhen < ItemCreatedWhen) 
...
SELECT DISTINCT
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerWeight AS HFTW
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTW.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTW.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTHA.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTHA.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTHA.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerHbA1c AS HFTHA
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTHA.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTHA.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTC.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTC.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTC.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerCholesterol AS HFTC
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTC.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTC.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTBSAG.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTBSAG.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTBSAG.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerBloodSugarAndGlucose AS HFTBSAG
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTBSAG.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTBSAG.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
     ...
     LEFT OUTER JOIN BASE_HFit_LKP_TrackerVendor AS VENDOR
     ON
       HFTBSAG.VendorID = VENDOR.ItemID
--11.21.2014 (wdm) add so that Account or Site data rows could be rejected if prior to a date specified wihtin table BASE_EDW_BiometricViewRejectCriteria
WHERE
      CS.SITEID NOT IN (SELECT
                               SiteID
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTBP.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTBP.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTBP.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerBloodPressure AS HFTBP
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTBP.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTBP.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTBF.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTBF.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTBF.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerBodyFat AS HFTBF
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTBF.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTBF.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTB.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTB.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTB.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerBMI AS HFTB
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTB.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTB.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTBM.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTBM.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTBM.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerBodyMeasurements AS HFTBM
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTBM.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTBM.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTH.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTH.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTH.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerHeight AS HFTH
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTH.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTH.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , cus2.SiteID
     , cs.SiteGUID
     , cast (HFTRHR.ItemCreatedWhen AS DATETIME) AS ItemCreatedWhen
     , cast (HFTRHR.ItemModifiedWhen AS DATETIME) AS ItemModifiedWhen
     , HFTRHR.Notes
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerRestingHeartRate AS HFTRHR
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTRHR.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTRHR.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerShots AS HFTS
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTS.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTS.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
...
SELECT DISTINCT
     ...
     , VENDOR.VendorName
FROM
     dbo.BASE_HFit_TrackerTests AS HFTT
     INNER JOIN dbo.BASE_HFit_TrackerCollectionSource AS HFTCS
     ON
       HFTT.TrackerCollectionSourceID = HFTCS.TrackerCollectionSourceID
     INNER JOIN dbo.BASE_CMS_UserSettings AS CUS
     ON
       HFTT.UserID = cus.UserSettingsUserID
     INNER JOIN dbo.BASE_CMS_UserSite AS CUS2
     ON
       cus.UserSettingsUserID = cus2.UserID
     INNER JOIN dbo.BASE_CMS_Site AS CS
