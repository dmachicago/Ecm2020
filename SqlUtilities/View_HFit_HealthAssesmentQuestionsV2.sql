...
/****** Object:  View [dbo].[View_HFit_HealthAssesmentQuestions]    Script Date: 7/15/2014 1:23:52 PM ******/
SET ANSI_NULLS ON
GO
...
--SELECT * 
--FROM dbo.View_HFit_HealthAssesmentQuestions AS VHFHAQ


CREATE VIEW [dbo].[View_HFit_HealthAssesmentQuestions]
