...
SELECT  
	...
	T.FISCAL_YEAR,
	T.FISCAL_PERIOD,
	dbo.nCurrentMoSalesAmt(T.FISCAL_YEAR, T.FISCAL_PERIOD, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Record_KEY, S.TIME_KEY)) as Current_Month_Sales_Extended_Amount,
	dbo.nYearToDateExtendedSalesAmt(T.FISCAL_YEAR, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Record_KEY, S.TIME_KEY)) as Year_To_Date_Extended_Sales_Amount,
	dbo.nPrevYearToDateSalesAmt(T.FISCAL_YEAR, T.FISCAL_PERIOD, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Record_KEY, S.TIME_KEY)) as Previous_Year_To_date_Sales_Amount,
...
UNION ALL 
	SELECT  
		...
		T.FISCAL_YEAR,
		T.FISCAL_PERIOD,
		dbo.nCurrentMoSalesAmt(T.FISCAL_YEAR, T.FISCAL_PERIOD, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Invoice_Ln_Key, S.TIME_KEY)) as Current_Month_Sales_Extended_Amount,
		dbo.nYearToDateExtendedSalesAmt(T.FISCAL_YEAR, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Invoice_Ln_Key, S.TIME_KEY)) as Year_To_Date_Extended_Sales_Amount,
		dbo.nPrevYearToDateSalesAmt(T.FISCAL_YEAR, T.FISCAL_PERIOD, dbo.nNetBillingAmt(S.Src_Sys_ID, S.Invoice_Ln_Key, S.TIME_KEY)) as Previous_Year_To_date_Sales_Amount,
