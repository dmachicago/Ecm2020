...
SELECT distinct
		...
		, HA.NodeGUID AS HADocumentID								--WDM 08.07.2014
		...
		, left(VHFHAMJ.IntroText,4000) AS IntroText
		...
		, VHFHAQ.QuestionType
		, left(VHFHAQ.Title,4000) AS QuesTitle
...
--WDM Retrieve Matrix Level 1 Question Group
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ2.Title,4000) AS QuesTitle
		, VHFHAQ2.Weight
		, VHFHAQ2.IsRequired
...
--WDM Retrieve Branching Level 1 Question and Matrix Level 1 Question Group
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ3.Title,4000) AS QuesTitle
		, VHFHAQ3.Weight
		, VHFHAQ3.IsRequired
...
--WDM Retrieve Branching Level 1 Question and Matrix Level 2 Question Group
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ7.Title,4000) AS QuesTitle
		, VHFHAQ7.Weight
		, VHFHAQ7.IsRequired
...
UNION ALL   --UNION
	...
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ8.Title,4000) AS QuesTitle
		, VHFHAQ8.Weight
		, VHFHAQ8.IsRequired
...
UNION ALL   --UNION
	...
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ4.Title,4000) AS QuesTitle
		, VHFHAQ4.Weight
		, VHFHAQ4.IsRequired
...
--WDM 6/25/2014 Retrieve the Branching level 3 Question Group
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ5.Title,4000) AS QuesTitle
		, VHFHAQ5.Weight
		, VHFHAQ5.IsRequired
...
--WDM 6/25/2014 Retrieve the Branching level 4 Question Group
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ6.Title,4000) AS QuesTitle
		, VHFHAQ6.Weight
		, VHFHAQ6.IsRequired
...
UNION ALL   --UNION
	...
	SELECT distinct
       ...
       --,VHFHARAJ.NodeAliasPath
		...
		, left(VHFHAQ9.Title,4000) AS QuesTitle
		, VHFHAQ9.Weight
		, VHFHAQ9.IsRequired
...
go
  ...
  --  
GO 
print('***** FROM: view_EDW_HealthAssesmentDeffinition_BAK.sql'); 
GO 
