...
/****** Object:  View [dbo].[view_EDW_HealthAssesmentDeffinition]    Script Date: 7/17/2014 7:09:28 AM ******/
SET ANSI_NULLS ON
GO
...
--7/19/2014 - The select statements in this view were tested in DEV by WDM and in PROD
--		by John C. The desired data was returned.
--		However, a NULL data set is being returned in DEV, TEST abd Staaging using the
...
GO
  ...
  --  
GO 
print('***** FROM: view_EDW_HealthAssesmentDeffinitionV2.sql'); 
GO 
