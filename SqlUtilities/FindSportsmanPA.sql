...
go
SELECT DISTINCT
        'SPORTSMAN' AS CLS, PA_ALL_Tags.PrimaryAddress1, PA_ALL_Tags.LastName, PA_ALL_Tags.FirstName, PA_ALL_Tags.MiddleName, PA_ALL_Tags.SuffixName, 
        PA_ALL_Tags.PrimaryCity, PA_ALL_Tags.PrimaryZip, PA_ALL_Tags.PrimaryZip4, 
		EmailAddress.EmailAll, PA_ALL_Tags.EMail, 
        ...
        PA_ALL_Tags.PrecinctNumber, PA_ALL_Tags.PrecinctName, PA_ALL_Tags.[COALITION: Hunter], PA_ALL_Tags.[COALITION: Sportsman], 
        PA_ALL_Tags.[COALITION: Veteran], EmailAddress.MARRIED, EmailAddress.CHILDREN, EmailAddress.INCOME, EmailAddress.HOMEOWNER, EmailAddress.LANGUAGE, 
        EmailAddress.GOLF, EmailAddress.OUTDOOR, EmailAddress.POLITICAL, 
		PA_ALL_Tags.primaryPhone,
        ...
        EmailAddress.VETERAN, PA_ALL_Tags.[COALTION: Catholic], PA_ALL_Tags.[COALITION: Social Conservative], PA_ALL_Tags.[COALITION: Agriculture], 
