...
--	Answer Node Guid -> Answer 
 ...
 -- 10.30.2014 : Sowmiya 
 -- The following are the possible values allowed in the HAStartedMode and HACompletedMode 
 -- columns of the Hfit_HealthAssesmentUserStarted table
 --		Unknown = 0, 
 --		Paper = 1,  // Paper HA
 ...
 -- 10.30.2014 WDM
 --	Per conversation with Sowmiya, removed HAPaperFlg and HATelephonicFlg
 -- 10.31.2014 WDM
 -- Per conversation with John C. and performance needs, the DISTINCT was removed from the query.
