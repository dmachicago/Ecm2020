...
/****** Object:  View [dbo].[GLOBAL_POS_V2]    Script Date: 10/25/2010 13:51:41 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[GLOBAL_POS_V2] AS
...
SELECT
	...
	ISNULL( P.BRANCH_ID, GRYTPR.SALES_OFFICE_NAME) AS BRANCH_ID,
	...
	CASE WHEN P.COST_CURRENCY_EXCHANGE_USD > 0 THEN 
		CASE WHEN P.DISTRIBUTOR_NAME IN ('ANIXTER-CH', 'ANIXTER-JP', 'ANIXTER-BY', 'ANIXTER-IS') 
			THEN 
				P.EXTENDED_COST * 1000 
			ELSE 
				P.EXTENDED_COST 
			END * P.COST_CURRENCY_EXCHANGE_USD 
		ELSE 
	...
	CASE WHEN (P.SRC_SYS_ID_POS = 'AXT_V2') 
		THEN 
			TRD1.FISCAL_YEAR 
		ELSE 
			TRD1.FISCAL_YEAR 
		END REPORT_ENDING_FISCAL_YEAR,
	...
	CASE WHEN (GRYTPR.TRADE_CLASS >= '81' AND GRYTPR.TRADE_CLASS <= '89') THEN 'Y' ELSE 'N' END AS GRAYBAR_GOVERNMENT_FLG,
	...
	dbo.nCurrentMoSalesAmtOrQty(
		...
		dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)
		) 
	as Current_Month_Sales_Extended_Amount,

	dbo.nYearToDateExtendedSalesAmtOrQty(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
			dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Year_To_Date_Extended_Sales_Amount,
			
	dbo.nPrevYearToDateSalesAmtOrQty(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), 
			dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), 
			dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Previous_Year_To_date_Sales_Amount,
			
	dbo.nSalesExtendedAmtYoYchange(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
			dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), 
			dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Sales_Extended_Amount_YoY_Change ,
	...
	dbo.nYearToDateExtendedSalesAmtOrQty(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) ,  
			P.QUANTITY ) as Year_To_Date_Extended_Quantity,
			
	dbo.nPrevYearToDateSalesAmtOrQty(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), 
			dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  
			P.QUANTITY) as Previous_Year_To_date_Quantity,
			
	dbo.nSalesExtendedAmtYoYchange(
			dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
			dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  
			P.QUANTITY) as Sales_Quantity_YoY_Change
	...
	LEFT OUTER JOIN (SELECT DISTINCT SRC_SYS_ID, INVOICE_NBR, SALES_OFFICE_NAME, TRADE_CLASS, PREFIX_PURCHASE_GROUP 
						FROM TPR_POS_GRAYBAR 
						WHERE Current_Ind = 'Y' and Delete_Ind = 'N') GRYTPR 
						/*ON P.SRC_SYS_ID_POS = GRYTPR.SRC_SYS_ID AND P.INVOICE_NUMBER = CAST(GRYTPR.INVOICE_NBR AS VARCHAR(50))*/
						ON P.SRC_SYS_ID_POS = GRYTPR.SRC_SYS_ID AND P.INVOICE_NUMBER_INT = GRYTPR.INVOICE_NBR /* SDM 10/25/2010 */
...
SELECT
	...
	dbo.nYearToDateExtendedSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
		dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) 
		as Year_To_Date_Extended_Sales_Amount,
		
	dbo.nPrevYearToDateSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
		dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), 
		dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) 
		as Previous_Year_To_date_Sales_Amount,
		
	dbo.nSalesExtendedAmtYoYchange(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
		dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), 
		dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) 
		as Sales_Extended_Amount_YoY_Change, 
	...
	dbo.nYearToDateExtendedSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) ,  
		P.QUANTITY ) 
		as Year_To_Date_Extended_Quantity,
	
	dbo.nPrevYearToDateSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
		dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  
		P.QUANTITY) 
		as Previous_Year_To_date_Quantity,
	
	dbo.nSalesExtendedAmtYoYchange(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR) , 
		dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  
		P.QUANTITY) 
		as Sales_Quantity_YoY_Change
	...
	LEFT OUTER JOIN XREF_ANIXTER_INFO ANX ON P.DISTRIBUTOR_NAME = ANX.DISTRIBUTOR_NAME
	LEFT OUTER JOIN TPR_POS_ANIXTER_V2 ANXTPR ON P.SRC_SYS_ID_POS = ANXTPR.SRC_SYS_ID AND P.INVOICE_NUMBER = ANXTPR.INVOICE_NUMBER AND P.DISTRIBUTOR_PART_NUMBER = ANXTPR.DISTRIBUTOR_PART_NUMBER AND P.EXTENDED_COST = ANXTPR.EXTENDED_UNIT_COST
	LEFT OUTER JOIN (SELECT DISTINCT SRC_SYS_ID, INVOICE_NBR, SALES_OFFICE_NAME, TRADE_CLASS, PREFIX_PURCHASE_GROUP FROM TPR_POS_GRAYBAR WHERE Current_Ind = 'Y' and Delete_Ind = 'N') GRYTPR ON P.SRC_SYS_ID_POS = GRYTPR.SRC_SYS_ID AND P.INVOICE_NUMBER_INT = GRYTPR.INVOICE_NBR   /* SDM 10/25/2010 */
	--LEFT OUTER JOIN (SELECT DISTINCT SRC_SYS_ID, INVOICE_NBR, SALES_OFFICE_NAME, TRADE_CLASS, PREFIX_PURCHASE_GROUP FROM TPR_POS_GRAYBAR WHERE Current_Ind = 'Y' and Delete_Ind = 'N') GRYTPR ON P.SRC_SYS_ID_POS = GRYTPR.SRC_SYS_ID AND P.INVOICE_NUMBER = CAST(GRYTPR.INVOICE_NBR AS VARCHAR(50))
	JOIN DM_D_CALENDAR T ON T.TIME_KEY=P.TIME_KEY
	LEFT OUTER JOIN DM_D_CALENDAR TRD ON TRD.TIME_KEY=convert(VARCHAR(10),P.REPORT_ENDING_DATE,112)
	LEFT OUTER JOIN DM_D_CALENDAR TRD1 ON TRD1.TIME_KEY=convert(VARCHAR(10),ANXTPR.REPORT_ENDING_DATE,112)
...
SELECT
 	CASE WHEN (P.SRC_SYS_ID_POS = 'AXT_V2' AND P.MANUFACTURER_NAME LIKE 'HIR%') THEN 'STDMHM'
			 ...
			 WHEN (GRYTPR.PREFIX_PURCHASE_GROUP IN ('BEDPT')) THEN 'TRAPEZ'
		ELSE P.SRC_SYS_ID END	AS SRC_SYS_ID,
	CASE WHEN (P.SRC_SYS_ID='BPCSEU') THEN 'EMEA'
...
SELECT
	...
	dbo.nCurrentMoSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Current_Month_Sales_Extended_Amount,
	dbo.nYearToDateExtendedSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Year_To_Date_Extended_Sales_Amount,
	dbo.nPrevYearToDateSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Previous_Year_To_date_Sales_Amount,
	dbo.nSalesExtendedAmtYoYchange(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), dbo.nSalesExtendedAmtUsd(P.DISTRIBUTOR_NAME,P.EXTENDED_COST,P.COST_CURRENCY_EXCHANGE_USD)) as Sales_Extended_Amount_YoY_Change, 
	
	dbo.nCurrentMoSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH), P.QUANTITY) as Current_Month_Quantity,
	dbo.nYearToDateExtendedSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR),  P.QUANTITY ) as Year_To_Date_Extended_Quantity,
	dbo.nPrevYearToDateSalesAmtOrQty(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  P.QUANTITY) as Previous_Year_To_date_Quantity,
	dbo.nSalesExtendedAmtYoYchange(
		dbo.sReportEndingCalendarYear(P.SRC_SYS_ID_POS,TRD1.YEAR,TRD.YEAR), dbo.sReportEndingcalendarMonth(P.SRC_SYS_ID_POS,TRD1.MONTH,TRD.MONTH),  P.QUANTITY) as Sales_Quantity_YoY_Change
