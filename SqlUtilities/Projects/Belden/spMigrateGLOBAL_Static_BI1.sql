create procedure spMigrateGLOBAL_Static_BI1
as 
...
INSERT INTO dbo.TEMP_B1_KEYS (RowID, Invoice_Number)
...
SELECT 
      ...
      ,B.[LastUpdate]
      ,B.[Extract]
FROM dbo.GLOBAL_BI_Extract1 B
where B.RowID
not in (Select RowID from dbo.TEMP_B1_KEYS) ;
...
SELECT [SRC_SYS_ID]
      ...
      ,[LastUpdate]
      ,[Extract]
  FROM [SMART].[dbo].[GLOBAL_BI_Extract1]
GO
