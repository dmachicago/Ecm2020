...
/****** Object:  Job [JOB_DFS_CleanDFSTables]    Script Date: 1/25/2019 12:06:16 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 1/25/2019 12:06:16 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Step-1]    Script Date: 1/25/2019 12:06:16 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Step-1', 
		...
		@command=N'exec DFS_CleanDFSTables @DaysToDelete = 2', 
