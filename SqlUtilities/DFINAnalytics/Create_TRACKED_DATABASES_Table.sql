...
USE DFINAnalyticsFINAnalyticsFINAnalyticsFINAnalytics;
GO
-- drop TABLE [dbo].[DFIN_TRACKED_DATABASES];
...
BEGIN
	...
	( 
				 [INSTANCE] [varchar](50) NOT NULL, [DATABASENAME] [varchar](100) NOT NULL, [REGION] [varchar](4) NOT NULL, [AuthenticationType] char(1) NOT NULL, UtilityUserID nvarchar(50) NULL, UtilityUserPW nvarchar(50) NULL, [UID] uniqueidentifier NOT NULL DEFAULT NEWID()
	);
	CREATE UNIQUE INDEX ukDFIN_TRACKED_DATABASES
ON DFIN_TRACKED_DATABASES
	( [INSTANCE], [DATABASENAME], [REGION]
	);
	CREATE UNIQUE INDEX pkDFIN_TRACKED_DATABASES
ON DFIN_TRACKED_DATABASES
	( [UID]
	);
END;
...
BEGIN
	...
	( 
				 [PROCNAME] [varchar](100) NOT NULL, [UID] uniqueidentifier NOT NULL DEFAULT NEWID()
	);
	CREATE UNIQUE INDEX pkDFIN_TRACKED_DATABASE_PROCS
