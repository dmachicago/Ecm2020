...
AS
 ...
 RAISERROR(@MSG, 10, 1) WITH NOWAIT;
    END;
go
IF object_id('tempdb..#UTIL_CPU_BoundQry2000') IS NOT NULL
...
AS
 ...
 exec #genInsertSql '#DFS_CPU_BoundQry2000', 'dbo.DFS_CPU_BoundQry2000', @stmt = @s OUTPUT;
		select  @s;
 EXECUTE sp_executesql @s;
		*/
    END;
GO
exec #UTIL_CPU_BoundQry2000 -99;
