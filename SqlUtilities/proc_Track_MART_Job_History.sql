...
go
print 'Execute proc_Track_MART_Job_History.sql'
go

if exists (select name from sys.procedures where name = 'proc_Track_MART_Job_History')
    drop procedure proc_Track_MART_Job_History ;
go
/*****************
 Create TempTable 
*****************/
...
create PROCEDURE proc_Track_MART_Job_History
AS
BEGIN
...
go
print 'Executed proc_Track_MART_Job_History.sql'
go
