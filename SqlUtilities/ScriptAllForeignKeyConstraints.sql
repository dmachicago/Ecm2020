...
if object_id('tempdb..##FK_Constraints') is not null
...
set @SqlCmd = 'ALTER TABLE '+quotename(@ParentTableSchema)+'.'+quotename(@ParentTableName)+' WITH CHECK ADD CONSTRAINT '+quotename(@ForeignKeyName)
...
insert into ##FK_Constraints 
(ForeignKeyID , ForeignKeyName , ParentTableName, ParentColumn, ReferencedTable, ReferencedColumn, GenSql )
values 
(@ForeignKeyID , @ForeignKeyName , @ParentTableName, @ParentColumn, @ReferencedTable, @ReferencedColumn, @SqlCmd )
