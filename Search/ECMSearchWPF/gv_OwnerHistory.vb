...
' ***********************************************************************
' <copyright file="gv_OwnerHistory.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_OwnerHistory.
''' </summary>
Partial Public Class gv_OwnerHistory
    ''' <summary>
    ''' Gets or sets the previous owner user identifier.
    ''' </summary>
    ''' <value>The previous owner user identifier.</value>
    <StringLength(50)>
    ...
    ''' <summary>
    ''' Gets or sets the current owner user identifier.
    ''' </summary>
    ''' <value>The current owner user identifier.</value>
    <StringLength(50)>
