...
' ***********************************************************************
' <copyright file="gv_AvailFileTypesUndefined.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_AvailFileTypesUndefined.
''' </summary>
Partial Public Class gv_AvailFileTypesUndefined
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the type of the substitute.
    ''' </summary>
    ''' <value>The type of the substitute.</value>
    <StringLength(50)>
    Public Property SubstituteType As String

    ''' <summary>
    ''' Gets or sets a value indicating whether this <see cref="gv_AvailFileTypesUndefined"/> is applied.
    ''' </summary>
    ''' <value><c>null</c> if [applied] contains no value, <c>true</c> if [applied]; otherwise, <c>false</c>.</value>
