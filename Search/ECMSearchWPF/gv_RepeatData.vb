...
' ***********************************************************************
' <copyright file="gv_RepeatData.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_RepeatData.
''' </summary>
Partial Public Class gv_RepeatData
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the repeat data desc.
    ''' </summary>
    ''' <value>The repeat data desc.</value>
    <StringLength(4000)>
    Public Property RepeatDataDesc As String
