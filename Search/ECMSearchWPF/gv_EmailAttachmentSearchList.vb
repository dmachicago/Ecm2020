...
' ***********************************************************************
' <copyright file="gv_EmailAttachmentSearchList.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_EmailAttachmentSearchList.
''' </summary>
Partial Public Class gv_EmailAttachmentSearchList
    ''' <summary>
