...
' ***********************************************************************
' <copyright file="gv_QuickRef.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_QuickRef.
''' </summary>
Partial Public Class gv_QuickRef
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the name of the quick reference.
    ''' </summary>
    ''' <value>The name of the quick reference.</value>
    <StringLength(50)>
    Public Property QuickRefName As String
