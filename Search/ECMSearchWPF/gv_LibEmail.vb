...
' ***********************************************************************
' <copyright file="gv_LibEmail.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_LibEmail.
''' </summary>
Partial Public Class gv_LibEmail
    ''' <summary>
    ''' Gets or sets the email folder entry identifier.
    ''' </summary>
    ''' <value>The email folder entry identifier.</value>
    <Key>
    <Column(Order:=0)>
    <StringLength(200)>
    Public Property EmailFolderEntryID As String
