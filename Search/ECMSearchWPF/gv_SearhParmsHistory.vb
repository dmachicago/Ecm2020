...
' ***********************************************************************
' <copyright file="gv_SearhParmsHistory.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_SearhParmsHistory
    ...
    ''' <summary>
    ''' Gets or sets the qry parms.
    ''' </summary>
    ''' <value>The qry parms.</value>
    <Key>
    <Column(Order:=3)>
