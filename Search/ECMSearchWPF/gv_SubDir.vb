...
' ***********************************************************************
' <copyright file="gv_SubDir.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_SubDir.
''' </summary>
Partial Public Class gv_SubDir
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the subfqn.
    ''' </summary>
    ''' <value>The subfqn.</value>
    <Key>
    <Column(Order:=1)>
    <StringLength(254)>
    Public Property SUBFQN As String
