...
' ***********************************************************************
' <copyright file="gv_RunParms.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_RunParms
    ''' <summary>
    ''' Gets or sets the parm.
    ''' </summary>
    ''' <value>The parm.</value>
    <Key>
    <Column(Order:=0)>
    <StringLength(250)>
    ...
    ''' <summary>
    ''' Gets or sets the parm value.
    ''' </summary>
    ''' <value>The parm value.</value>
    <StringLength(50)>
    ...
    ''' <summary>
    ''' Gets or sets the parm desc.
    ''' </summary>
    ''' <value>The parm desc.</value>
    <StringLength(500)>
