...
' ***********************************************************************
' <copyright file="gv_DeleteF_07202017134505007.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_DeleteF_07202017134505007.
''' </summary>
Partial Public Class gv_DeleteF_07202017134505007
    ''' <summary>
    ''' Gets or sets from email addr.
    ''' </summary>
    ''' <value>From email addr.</value>
    <Key>
    <Column(Order:=0)>
    <StringLength(254)>
