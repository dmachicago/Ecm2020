...
' ***********************************************************************
' <copyright file="gv_SubLibrary.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_SubLibrary.
''' </summary>
Partial Public Class gv_SubLibrary
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the sub user identifier.
    ''' </summary>
    ''' <value>The sub user identifier.</value>
    <Key>
    <Column(Order:=1)>
    <StringLength(50)>
    Public Property SubUserID As String
    ...
    ''' <summary>
    ''' Gets or sets the name of the sub library.
    ''' </summary>
    ''' <value>The name of the sub library.</value>
    <Key>
    <Column(Order:=3)>
    <StringLength(80)>
    Public Property SubLibraryName As String
