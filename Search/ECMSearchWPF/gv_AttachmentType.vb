...
' ***********************************************************************
' <copyright file="gv_AttachmentType.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_AttachmentType.
''' </summary>
Partial Public Class gv_AttachmentType
    ''' <summary>
    ''' Gets or sets the attachment code.
    ''' </summary>
    ''' <value>The attachment code.</value>
    <Key>
    <StringLength(50)>
    ...
    ''' <summary>
    ''' Gets or sets a value indicating whether this instance is zip format.
    ''' </summary>
    ''' <value><c>null</c> if [is zip format] contains no value, <c>true</c> if [is zip format]; otherwise, <c>false</c>.</value>
