...
' ***********************************************************************
' <copyright file="gv_InformationProduct.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_InformationProduct
    ...
    ''' <summary>
    ''' Gets or sets the volitility code.
    ''' </summary>
    ''' <value>The volitility code.</value>
    <Key>
    <Column(Order:=2)>
    <StringLength(50)>
    ...
    ''' <summary>
    ''' Gets or sets the information type code.
    ''' </summary>
    ''' <value>The information type code.</value>
    <Key>
    <Column(Order:=5)>
    <StringLength(50)>
