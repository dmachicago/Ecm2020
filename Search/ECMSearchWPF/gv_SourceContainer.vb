...
' ***********************************************************************
' <copyright file="gv_SourceContainer.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_SourceContainer.
''' </summary>
Partial Public Class gv_SourceContainer
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the container desc.
    ''' </summary>
    ''' <value>The container desc.</value>
    <StringLength(4000)>
