...
' ***********************************************************************
' <copyright file="gv_BusinessJargonCode.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_BusinessJargonCode.
''' </summary>
Partial Public Class gv_BusinessJargonCode
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the jargon desc.
    ''' </summary>
    ''' <value>The jargon desc.</value>
    <StringLength(18)>
    Public Property JargonDesc As String
