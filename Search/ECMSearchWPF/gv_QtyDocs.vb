...
' ***********************************************************************
' <copyright file="gv_QtyDocs.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_QtyDocs.
''' </summary>
Partial Public Class gv_QtyDocs
    ''' <summary>
    ''' Gets or sets the qty document code.
    ''' </summary>
    ''' <value>The qty document code.</value>
    <Key>
    <StringLength(10)>
