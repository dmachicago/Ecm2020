...
' ***********************************************************************
' <copyright file="gv_ProcessFileAs.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_ProcessFileAs.
''' </summary>
Partial Public Class gv_ProcessFileAs
    ''' <summary>
    ''' Gets or sets the ext code.
    ''' </summary>
    ''' <value>The ext code.</value>
    <Key>
    <Column(Order:=0)>
    <StringLength(50)>
    ...
    ''' <summary>
    ''' Gets or sets the process ext code.
    ''' </summary>
    ''' <value>The process ext code.</value>
    <Key>
    <Column(Order:=1)>
    <StringLength(50)>
    Public Property ProcessExtCode As String

    ''' <summary>
    ''' Gets or sets a value indicating whether this <see cref="gv_ProcessFileAs"/> is applied.
    ''' </summary>
