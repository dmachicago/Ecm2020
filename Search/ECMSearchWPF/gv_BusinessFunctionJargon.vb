...
' ***********************************************************************
' <copyright file="gv_BusinessFunctionJargon.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_BusinessFunctionJargon.
''' </summary>
Partial Public Class gv_BusinessFunctionJargon
    ...
    ''' <summary>
    ''' Gets or sets the jargon words TGT word.
    ''' </summary>
    ''' <value>The jargon words TGT word.</value>
    <Key>
    <Column(Order:=2)>
    <StringLength(50)>
