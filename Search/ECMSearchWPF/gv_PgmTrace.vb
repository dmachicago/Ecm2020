...
' ***********************************************************************
' <copyright file="gv_PgmTrace.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_PgmTrace.
''' </summary>
Partial Public Class gv_PgmTrace
    ''' <summary>
    ''' Gets or sets the statement identifier.
    ''' </summary>
    ''' <value>The statement identifier.</value>
    <StringLength(50)>
    Public Property StmtID As String

    ''' <summary>
    ''' Gets or sets the name of the PGM.
    ''' </summary>
    ''' <value>The name of the PGM.</value>
    <StringLength(254)>
    Public Property PgmName As String
    ...
    <Key>
    <Column(Order:=0)>
    Public Property Stmt As String
