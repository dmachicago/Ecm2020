...
' ***********************************************************************
' <copyright file="gv_GroupUsers.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_GroupUsers
    ...
    ''' <summary>
    ''' Gets or sets a value indicating whether [read only access].
    ''' </summary>
    ''' <value><c>null</c> if [read only access] contains no value, <c>true</c> if [read only access]; otherwise, <c>false</c>.</value>
    ...
    ''' <summary>
    ''' Gets or sets a value indicating whether this <see cref="gv_GroupUsers"/> is searchable.
    ''' </summary>
