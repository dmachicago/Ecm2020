...
' ***********************************************************************
' <copyright file="gv_JargonWords.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_JargonWords.
''' </summary>
Partial Public Class gv_JargonWords
    ''' <summary>
    ''' Gets or sets the TGT word.
    ''' </summary>
    ''' <value>The TGT word.</value>
    <Key>
    <Column(Order:=0)>
    <StringLength(50)>
    Public Property tgtWord As String

    ''' <summary>
    ''' Gets or sets the j desc.
    ''' </summary>
    ''' <value>The j desc.</value>
    <StringLength(4000)>
    Public Property jDesc As String
