...
' ***********************************************************************
' <copyright file="gv_LoadProfile.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_LoadProfile.
''' </summary>
Partial Public Class gv_LoadProfile
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the profile desc.
    ''' </summary>
    ''' <value>The profile desc.</value>
    <StringLength(254)>
    Public Property ProfileDesc As String
