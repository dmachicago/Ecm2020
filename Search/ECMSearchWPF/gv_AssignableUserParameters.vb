...
' ***********************************************************************
' <copyright file="gv_AssignableUserParameters.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_AssignableUserParameters.
''' </summary>
Partial Public Class gv_AssignableUserParameters
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets a value indicating whether this instance is perm.
    ''' </summary>
    ''' <value><c>null</c> if [is perm] contains no value, <c>true</c> if [is perm]; otherwise, <c>false</c>.</value>
    Public Property isPerm As Boolean?
