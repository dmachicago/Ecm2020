...
' ***********************************************************************
' <copyright file="gv_Storage.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_Storage.
''' </summary>
Partial Public Class gv_Storage
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the store desc.
    ''' </summary>
    ''' <value>The store desc.</value>
    <StringLength(18)>
