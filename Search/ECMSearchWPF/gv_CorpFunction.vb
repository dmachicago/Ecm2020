...
' ***********************************************************************
' <copyright file="gv_CorpFunction.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_CorpFunction
    ...
    ''' <summary>
    ''' Gets or sets the corp function desc.
    ''' </summary>
    ''' <value>The corp function desc.</value>
    <StringLength(4000)>
