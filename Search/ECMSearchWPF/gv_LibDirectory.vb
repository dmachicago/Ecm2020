...
' ***********************************************************************
' <copyright file="gv_LibDirectory.vb" company="D. Miller and Associates, Limited">
...
Partial Public Class gv_LibDirectory
    ...
    ''' <summary>
    ''' Gets or sets a value indicating whether [include sub dirs].
    ''' </summary>
    ''' <value><c>null</c> if [include sub dirs] contains no value, <c>true</c> if [include sub dirs]; otherwise, <c>false</c>.</value>
