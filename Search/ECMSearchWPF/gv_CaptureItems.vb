...
' ***********************************************************************
' <copyright file="gv_CaptureItems.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_CaptureItems.
''' </summary>
Partial Public Class gv_CaptureItems
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the capture items desc.
    ''' </summary>
    ''' <value>The capture items desc.</value>
    <StringLength(18)>
    Public Property CaptureItemsDesc As String
