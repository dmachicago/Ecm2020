...
Public Class clsSql
    ...
    Function GenDocSearchSql(ByVal SearchString As String, ByVal ckLimitToExisting As Boolean, ByVal txtThesaurus As String, ByVal cbThesaurusText As String, ByVal ckLimitToLib As Boolean, ByVal LibraryName As String) As String
        ...
        Else
            ...
            If bCopyToClipboard Then
                Dim tClip$ = "/* Part2 */ " + Environment.NewLine
                tClip += GeneratedSQL$
            End If
        ...
        If bCopyToClipboard Then
            Dim tClip$ = "/* Final */ " + Environment.NewLine
            tClip += GeneratedSQL$
        End If
    ...
    Function GenEmailGeneratedSQL(ByVal ckLimitToExisting As Boolean,
        ...
        If bCopyToClipboard Then
            Dim tClip$ = "/* WhereClause$ */ " + Environment.NewLine
            tClip += WhereClause$
        End If

        EmailSql = GeneratedSQL$ + Environment.NewLine
        If bCopyToClipboard Then
            Dim tClip$ = "/* ContainsClause */ " + Environment.NewLine
            tClip += EmailSql
        End If
        ...
        If ContainsClause.Trim.Length > 0 Then
            ...
            Else
                ...
                Else
                    Dim IncludeEmailAttachmentsQry$ = EmailSql + Environment.NewLine
                    'If ckIncludeAttachments.Checked Then
                    Dim ckIncludeAttachments As Boolean = True
                    IncludeEmailAttachmentsSearch(ckIncludeAttachments, ckWeighted, ckBusiness, txtSearch, ckLimitToExisting, txtThesaurus, cbThesaurusText, LibraryName$, bIncludeAllLibs)
                    'If ckIncludeAttachments = True And ckLimitToLib = False Then
    ...
    Sub client_getSynonyms(S As String)
        ...
        If S.Length > 0 Then
            ...
            For Each SS As String In words
                ...
                End If
                ListOfPhrases$ = ListOfPhrases$ + ChrW(9) + tWord + " or " + Environment.NewLine
            Next
                    ...
                    If InputSearchString$.Length > 0 Or txtThesaurus.Trim.Length > 0 Then
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            ...
                            If ExpandedWordList.Trim.Length > 0 Then
                                WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " FREETEXT ((Body, SUBJECT, KeyWords, Description), '" + ExpandedWordList
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            Dim ExpandedWordList As String = PopulateThesaurusList(ThesaurusList, ThesaurusWords, txtThesaurus, cbThesaurusText)
                            If ExpandedWordList.Trim.Length > 0 Then
                                WhereClause += Environment.NewLine + ChrW(9) + " OR FREETEXT ((Body, SUBJECT, KeyWords, Description), '" + ExpandedWordList
                                WhereClause += "') "
                                rParens += 1
                            End If
                        End If
                    ...
                    If InputSearchString$.Length > 0 Or txtThesaurus.Trim.Length > 0 Then
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            ...
                            If ExpandedWordList.Trim.Length > 0 Then
                                ...
                                WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " (CONTAINS (body, '" + ExpandedWordList
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            ...
                            If ExpandedWordList.Trim.Length > 0 Then
                                WhereClause = WhereClause + Environment.NewLine
                                WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " (CONTAINS (subject, '" + ExpandedThesaurusWords
                ...
                If useFreetext = True Then
                    If InputSearchString$.Length > 0 Or txtThesaurus.Trim.Length > 0 Then
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            Dim ExpandedWordList As String = PopulateThesaurusList(ThesaurusList, ThesaurusWords, txtThesaurus, cbThesaurusText)
                            If ExpandedWordList.Trim.Length > 0 Then
                                'WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " freetext (SourceImage, '" + ExpandedWordList
                                'WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " freetext (DataSource.*, '" + ExpandedWordList
                                WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " freetext ((Description, KeyWords, Notes, SourceImage, SourceName), '" + ExpandedWordList
                ...
                Else
                    If InputSearchString$.Length > 0 Or txtThesaurus.Trim.Length > 0 Then
                        ...
                        If txtThesaurus.Trim.Length > 0 Then
                            Dim ExpandedWordList As String = PopulateThesaurusList(ThesaurusList, ThesaurusWords, txtThesaurus, cbThesaurusText)
                            If ExpandedWordList.Trim.Length > 0 Then
                                WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " CONTAINS (SourceImage, '" + ExpandedWordList
            ...
            Else
                If InputSearchString$.Length > 0 Or txtThesaurus.Trim.Length > 0 Then
                    ...
                    If txtThesaurus.Trim.Length > 0 Then
                        Dim ExpandedWordList As String = PopulateThesaurusList(ThesaurusList, ThesaurusWords, txtThesaurus, cbThesaurusText)
                        If ExpandedWordList.Trim.Length > 0 Then
                            WhereClause += Environment.NewLine + ChrW(9) + cbThesaurusText + " CONTAINS (*, '" + ExpandedWordList
...
REEVAL:
    ...
    Function getEmailTblColsMainSearch(ByVal ckWeighted As Boolean, ByVal ckBusiness As Boolean, ByVal SearchText As String) As String
        ...
        Else
            ...
            GenSql = GenSql + " ,[EmailGuid], RetentionExpirationDate, isPublic, ConvertEmlToMSG, UserID, NbrAttachments, SourceTypeCode, 'N' as FoundInAttachment, ' ' as RID, RepoSvrName, 0 as RANK   " + Environment.NewLine
    ...
    Function getEmailTblCols(ByVal ckWeighted As Boolean, ByVal ckBusiness As Boolean, ByVal SearchText As String) As String
        ...
        Else
            ...
            SearchSql = SearchSql + " ,[EmailGuid], RetentionExpirationDate, isPublic, UserID, SourceTypeCode, NbrAttachments, ' ' as RID, RepoSvrName, 0 as RANK " + Environment.NewLine
    ...
    Function xgenHeader() As String
        Dim DocsSql$ = "WITH LibrariesContainingUser (LibraryName) AS" + Environment.NewLine
    ...
    Function genContenCountSql() As String
        Dim DocsSql$ = "Select count(*) " + Environment.NewLine
        DocsSql += "FROM DataSource " + Environment.NewLine
        Return DocsSql
    End Function
    ''' <summary>
    ...
    Public Function genUseExistingRecordsOnly(ByVal bUseExisting As Boolean, ByVal GuidColName As String) As String
        If bUseExisting = False Then
            Return ""
        End If
        Dim DocsSql$ = " and " + GuidColName$ + " in (SELECT [DocGuid] FROM ActiveSearchGuids where  UserID = '" + gCurrUserGuidID + "')" + Environment.NewLine
        Return DocsSql
    End Function
    ''' <summary>
...
GetNextChar:
    ...
    Function genIsInLibrariesSql() As Boolean
        ...
        Catch ex As Exception
            B = False
            LOG.WriteToSqlLog("ERROR genIsInLibrariesSql: " + ex.Message + Environment.NewLine + S)
        End Try
    ...
    Sub AddPaging(ByVal StartPageNo As Integer, ByVal EndPageNo As Integer, ByRef SqlQuery As String, ByVal bIncludeLibraryFilesInSearch As Boolean)
        ...
        Dim A$() = SqlQuery.Split(Environment.NewLine)
        ...
        For i As Integer = 0 To UBound(A)
            ...
            If InStr(S, "/*") > 0 And InStr(S, "*/") > 0 Then
                L.Add(ChrW(9) + S + Environment.NewLine)
                GoTo NEXTLINE
            End If
            ...
            If InStr(S, "ORDER BY KEY_TBL.RANK DESC", CompareMethod.Text) > 0 Then
                WeightedSearch = True
                S = ChrW(9) + "/* " + S + " */" + Environment.NewLine + ChrW(9) + "/* above commented out by Pagination Module */"
            End If
            ...
            ElseIf InStr(S, "FROM datasource", CompareMethod.Text) > 0 Or InStr(S, "FROM DataSource", CompareMethod.Text) > 0 Then
                If WeightedSearch = True Then
                    L.Add(ChrW(9) + ",ROW_NUMBER() OVER (ORDER BY Rank DESC) AS ROWID" + Environment.NewLine)
                Else
                    L.Add(ChrW(9) + ",ROW_NUMBER() OVER (ORDER BY SourceName ASC) AS ROWID" + Environment.NewLine)
                End If
            ...
            ElseIf InStr(S, "FROM EMAIL", CompareMethod.Text) > 0 Then
                If WeightedSearch = True Then
                    L.Add(ChrW(9) + ",ROW_NUMBER() OVER (ORDER BY Rank DESC) AS ROWID" + Environment.NewLine)
                Else
                    L.Add(ChrW(9) + ",ROW_NUMBER() OVER (ORDER BY SentOn ASC) AS ROWID" + Environment.NewLine)
                End If
