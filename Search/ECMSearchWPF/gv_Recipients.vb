...
' ***********************************************************************
' <copyright file="gv_Recipients.vb" company="D. Miller and Associates, Limited">
...
''' Class gv_Recipients.
''' </summary>
Partial Public Class gv_Recipients
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the type recp.
    ''' </summary>
    ''' <value>The type recp.</value>
    <StringLength(10)>
    Public Property TypeRecp As String
