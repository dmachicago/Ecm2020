...
' ***********************************************************************
' <copyright file="gv_RetentionTemp.vb" company="D. Miller and Associates, Limited">
...
''' <summary>
''' Class gv_RetentionTemp.
''' </summary>
Partial Public Class gv_RetentionTemp
    ''' <summary>
    ...
    ''' </summary>
    ''' <value>The content of the type.</value>
    <Key>
    <Column(Order:=2)>
    <StringLength(50)>
    Public Property TypeContent As String
