...
Public Class clsARCHIVEHISTCONTENTTYPE
    ...
    Public Sub setArchiveid(ByRef val as string)
        ...
        End If
        If Len(val) = 0 Then
            If gRunUnattended = false Then MsgBox("SET: Field 'Archiveid' cannot be NULL: 2100.")
            Return
        End If
    ...
    Public Sub setDirectory(ByRef val as string)
        If Len(val) = 0 Then
            If gRunUnattended = false Then MsgBox("SET: Field 'Directory' cannot be NULL.")
            Return
        End If
        val = UTIL.RemoveSingleQuotes(val)
        Directory = val
    ...
    Public Sub setFiletype(ByRef val as string)
        If Len(val) = 0 Then
            If gRunUnattended = false Then MsgBox("SET: Field 'Filetype' cannot be NULL.")
            Return
        End If
        val = UTIL.RemoveSingleQuotes(val)
        FileType = val
    ...
    Public Function getArchiveid() As String
        If Len(ArchiveID) = 0 Then
            If gRunUnattended = false Then MsgBox("GET: Field 'Archiveid' cannot be NULL: 2200.")
            Return ""
        End If
    ...
    Public Function getDirectory() As String
        If Len(Directory) = 0 Then
            If gRunUnattended = false Then MsgBox("GET: Field 'Directory' cannot be NULL.")
            Return ""
        End If
    ...
    Public Function getFiletype() As String
        If Len(FileType) = 0 Then
            If gRunUnattended = false Then MsgBox("GET: Field 'Filetype' cannot be NULL.")
            Return ""
        End If
    ...
    Public Function cnt_PK111(ByVal ArchiveID As String, ByVal Directory As String, ByVal FileType As String) As Integer
        ...
        Dim B As Integer = 0
        Dim TBL$ = "ArchiveHistContentType"
        Dim WC$ = "Where ArchiveID = '" + ArchiveID + "' and   Directory = '" + Directory + "' and   FileType = '" + FileType + "'"
    ...
    Public Function getRow_PK111(ByVal SecureID As Integer, ByVal ArchiveID As String, ByVal Directory As String, ByVal FileType As String) As SqlDataReader
