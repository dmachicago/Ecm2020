...
Public Class clsSql
    ...
    Sub GetToken(ByVal I As Integer, ByRef k As Integer, ByVal tStr$)
    ...
    Sub TranslateDelimiter(ByVal CH$, ByRef Translateddel$)
        Translateddel$ = ""
        Select Case CH
            Case "+"
                Translateddel$ = "And"
    ...
    'Function getEmailTblColsMainSearch(ByVal ckWeighted As Boolean, ByVal ckBusiness As Boolean, ByVal SearchText$) As String
    '    Dim GenSql$ = ""
    ...
    Sub ParseSearchString(ByRef A As ArrayList, ByVal S$)
        Dim I As Integer = 0
        Dim J As Integer = 0
...
reeval:
        ...
        Next
    End Sub
    Sub RebuildString(ByVal A As ArrayList, ByRef S$)
...
ProcessNextToken:
        ...
        S$ = S$.Trim
    End Sub
    Public Function CountDoubleQuotes(ByVal S$) As Boolean
        S$ = S$.Trim
