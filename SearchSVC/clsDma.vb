...
Public Class clsDma
    ...
    Public Sub WildCardCharValidate(ByRef StringToEval$)
    ...
    Function isFourPartIP(ByVal IP$) As Boolean
        If InStr(IP, ":") > 0 Then
            Return False
        End If
        Dim A$() = IP.Split(".")
    ...
    Public Function RemoveChar(ByVal tVal$, ByVal CharToRemove$) As String
        Dim i As Integer = Len(tVal)
        Dim A$()
        Dim S$ = ""
    ...
    Public Function ReplaceChar(ByVal InputString$, ByVal CharToReplace$, ByVal ReplaceWith$) As String
...
#If frmReconShow Then
    ...
    End Function
#End If
    Function getFilesInDir(ByVal DirName$, ByRef DirFiles$(), ByVal IncludedTypes As ArrayList, ByVal ExcludedTypes As ArrayList, ByVal ckArchiveFlag As Boolean) As Integer
...
NextFile:
    ...
    Sub ReplaceStar(ByRef tVal$)
        ...
        End If
    End Sub
    Sub ReplaceSingleTick(ByRef tVal$)
        tVal = tVal.Trim
        Dim CH$ = ""
        If InStr(tVal, "'") = 0 Then
            Return
    ...
    Function ToggleArchiveBit(ByVal filespec$) As Boolean
    ...
    Function setArchiveBitOff(ByVal filespec$) As Boolean
    ...
    Public Function formatTextSearch(ByVal SearchString$) As String
    ...
    Function ckKeyWord(ByVal KW$) As Boolean
        Dim B As Boolean = False
        KW = UCase(KW)
        Select Case KW
            Case "NEAR"
    ...
    Sub ckFirstTokenKeyWord(ByRef tStr$)
        Try
            Dim S$ = tStr
            Dim A$() = Split(S, " ")
            If UBound(A) > 0 Then
    ...
    Public Function getDebug(ByVal FormID$) As Boolean
    ...
    Function getEnvironmentDir(ByVal DirName$) As String
    ...
    Public Function setHelpDir(ByVal HelpFile$) As String
        Dim tDir$ = App_Path()
    ...
    Sub ckFreetextSearchLine(ByRef SearchText As TextBox)
        ...
        SearchText.Text = S
    End Sub
    Sub ckFreetextRemoveOr(ByRef SqlQuery$, ByVal LocatorPhrase$)
        '" FREETEXT ("
        'FREETEXT (EMAIL.*
        'freetext (subject,
        Dim S$ = SqlQuery$.Trim
        ...
        SqlQuery$ = S
    End Sub
    Function CalcCRC(ByVal FQN$) As String
    ...
    End Function
    Public Function getDirName(ByVal FQN$) As String
    ...
    Public Function getFileName(ByVal FQN$) As String
        ...
        End Try
    End Function
    Public Function getFullPath(ByVal FQN$) As String
        Dim dirName As String = IO.Path.GetFullPath(FQN)
        Return dirName
    End Function
    Public Function getFileExtension(ByVal FQN$) As String
...
#If frmReconShow Then
    Sub GetAllDirs(ByVal DirFqn$, ByRef result As List(Of String))
...
#End If
    ...
    Sub CombineLists(ByRef ParentList As List(Of String), ByRef ChildList As List(Of String))
        ...
        ChildList.Clear()
    End Sub
    Sub FixFileExtension(ByRef Extension$)
        ...
        Return
    End Sub
    Function isExtIncluded(ByVal fExt$, ByVal IncludedTypes As ArrayList) As Boolean
        fExt = UCase(fExt)
        ...
        End If
    End Function
    Function isExtExcluded(ByVal fExt$, ByVal ExcludedTypes As ArrayList) As Boolean
    ...
    End Function
    Function commentOutOrderBy(ByVal sTxt$) As String
        Dim S$ = sTxt$
        ...
        Return S
    End Function
    Function CreateMissingDir(ByVal DirFQN$) As Boolean
    ...
    Sub LogThis(ByVal MSG$)
        Dim LOG As New clsLogging
        LOG.WriteToSqlLog(MSG)
        LOG = Nothing
    End Sub
    Function ReadFile(ByVal fName$) As String
        ...
        Return FullText$
    End Function
    Sub WriteFile(ByVal FQN$, ByVal sText$)
        Try
    ...
    End Sub
    Sub ModifyAppConfig(ByVal ServerName$, ByVal ItemToModify$)
        ...
        End If
    End Sub
    Sub SetUserConnectionString(ByVal ServerName$)
    ...
    End Sub
    Sub SetThesaurusConnectionStringToConfig(ByVal ServerName$)
    ...
    End Sub
    Sub ApplyAppConfigChange(ByVal ServerName$, ByVal ItemToModify$, ByRef AppConFigBody As String)
    ...
    Public Sub deleteDirectoryFiles(ByVal DirFQN$)
