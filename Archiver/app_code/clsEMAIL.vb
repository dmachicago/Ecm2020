...
Public Class clsEMAIL
    ...
    Public Function InsertNewEmail(MachineName As String,
        ...
        s = s + "EmailGuid," + Environment.NewLine
        ...
        s = s + "ReadReceiptRequested," + Environment.NewLine
        ...
        s = s + "Sensitivity," + Environment.NewLine
        s = s + "SentOn," + Environment.NewLine
        s = s + "MsgSize," + Environment.NewLine
        s = s + "DeferredDeliveryTime," + Environment.NewLine
        s = s + "EntryID," + Environment.NewLine
        s = s + "ExpiryTime," + Environment.NewLine
        s = s + "LastModificationTime," + Environment.NewLine
        's = s + "EmailImage," + environment.NewLine
        s = s + "Accounts," + Environment.NewLine
        ...
        's = s + EmailImage + "," + environment.NewLine
        s = s + "'" + Accounts + "'" + "," + Environment.NewLine
        's = s + RowID + "," + environment.NewLine
        s = s + "'" + ShortSubj + "'" + "," + Environment.NewLine
        s = s + "'" + SourceTypeCode + "'" + "," + Environment.NewLine
        s = s + "'" + OriginalFolder + "'" + "," + Environment.NewLine
        s = s + "'" + StoreID + "'" + "," + Environment.NewLine
        s = s + "'" + EmailIdentifier + "', " + Environment.NewLine
        s = s + "'" + CRC + "', " + Environment.NewLine
        s = s + "'" + CRC + "') " + Environment.NewLine
