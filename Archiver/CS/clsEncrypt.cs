...
namespace EcmArchiveClcSetup
{
	public class clsEncrypt
	{
		...
		public string DecryptTripleDES(string sOut)
		{
			...
			{
				LOG.WriteToArchiveLog("DecryptTripleDES - Error in decrypting string.");
				//** messagebox.show("Error in decrypting string.")
			}
			...
			for (int i = 1; i <= (AR.Length - 1); i++)
			{
				...
				if (i % 2 == 0)
				{
					...
					catch (Exception ex)
					{
						...
						LOG.WriteToArchiveLog((string) ("clsEncrypt : xt001trc : 104 : " + ex.Message));
					}
		...
		public string DecryptTripleDES128(string sOut, bool B)
		{
			...
			{
				LOG.WriteToArchiveLog((string) ("clsEncrypt : DecryptTripleDES : 141 : " + ex.Message));
				return "";
			}
		}
	}
