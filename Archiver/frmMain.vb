...
#End If
                        ...
                        For K As Int32 = 0 To FilesToArchive.Count - 1 : LL = 2186
                            ...
                            If NbrFilesFoundInRepo = 0 And ListOfGuids.Count.Equals(0) Then : LL = 3556
                                ...
                                LOG.WriteToArchiveLog("INFO: File - " + file_FullName + " was found to be NEW and not in the repository.") : LL = 3586
...
GoodLogin:
    ...
    Private Sub PerformContentArchive()
        ...
        If UseDirectoryListener.Equals(1) And Not gTempDisableDirListener Then
            Dim BB As Boolean = DBLocal.removeListenerfileProcessed()
...
SkipIT:
    ...
    Sub ProcessUnexplodedZipFiles()
        ...
        Dim StackLevel As Integer = 0
        Dim RetentionCode As String = ""
        Dim RetentionDate As DateTime = Nothing
        Dim RetentionExpirationDate As DateTime = Nothing
        ...
        Dim DirToDelete As New List(Of String)
...
SHIPTHISONE:
        ...
        DirToDelete.Reverse()
        FileToDelete.Sort()
        FileToDelete.Reverse()

        frmNotify2.PB.Maximum = FileToDelete.Count + 1
        Dim ix As Integer = 0
        For Each strfqn In FileToDelete
            ix += 1
            frmNotify2.lblMsg2.Text = "Removing: " + strfqn
            frmNotify2.lblFolder.Text = ix.ToString + " of " + FileToDelete.Count.ToString
            frmNotify2.PB.Increment(1)
            If File.Exists(strfqn) Then
                Try
                    File.Delete(strfqn)
                Catch ex As Exception
        ...
        frmNotify2.Close()
        frmNotify2.Dispose()
        SB.Text = "ZIP FILE ANALYSIS COMPLETED..."
