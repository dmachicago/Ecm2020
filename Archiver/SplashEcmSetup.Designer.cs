...
{
    [DesignerGenerated()]
    public partial class SplashEcmSetup : Form
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(SplashEcmSetup));
            ...
            Load += new EventHandler(SplashEcmSetup_Load);
            ResumeLayout(false);
        }
    }
}