...
Public Class frmAppConfigEdit
    ...
    Function GetScreenParms() As String
        ...
        S += "txtConnectionID" + "|" + txtConnectionID.Text.Trim + Chr(127)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        For Each S In A
            ...
            If ParmName.Trim.Length > 0 Then
                ...
                ElseIf ParmName.Equals("txtConnectionID") Then
                    txtConnectionID.Text = ParmVal
    ...
    Public Function iCount(ByVal S as string) As Integer
        ...
        Try
            ...
            Return Cnt
        Catch ex As Exception
            MessageBox.Show("clsDatabase : iCount : 2054 : " + ex.Message)
            Return -1
        Finally
    ...
    Private Sub btnLoadCombo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadCombo.Click
        ...
        Try
            ...
            CONN.Dispose()
        Catch ex As Exception
            MessageBox.Show("Failed to load master connection - please fill in manually and try to connect.")
        Finally
    ...
    Sub DecryptParmsAndApply(ByVal tgtStr)
        Dim DecryptedParms As String = ENC.AES256DecryptString(tgtStr)
        If DecryptedParms Is Nothing Then
            MsgBox("Data not found, please recreate, resave and try again.")
            Return
        End If
        Dim A() As String = DecryptedParms.Split(Chr(127))
