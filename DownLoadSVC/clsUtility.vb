...
Public Class clsUtility
    ...
    Function spaceCnt(ByVal FQN$) As Integer
    ...
    Public Function GetParentImageProcessingFile() As String
        ...
        Try
            ...
            If spaceCnt(S) > 0 Then
                WriteToSqlLog("ERROR: PdfProcessingDir (config.app) CANNOT HAVE SPAVES IN THE NAME, defauling to C:\Temp\")
                S = "C:\Temp\"
            End If
    ...
    Public Overloads Function getTempPdfWorkingDir(ByVal RetainFiles As Boolean) As String
    ...
    Public Overloads Function getTempPdfWorkingErrorDir() As String
    ...
    Public Function RemoveSingleQuotes(ByVal tVal As String) As String
        ...
        Return tVal
    End Function
    Public Function RemoveBadChars(ByVal tVal$) As String
        Try
            Dim i As Integer = Len(tVal)
            Dim ch As String = ""
            Dim S$ = "0123456789 abcdefghijklmnopqrstuvwxyz."
            For i = 1 To Len(tVal)
                ch = Mid(tVal, i, 1)
            ...
            Next
        Catch ex As Exception
            Me.WriteToSqlLog("ERROR: clsUtility:RemoveBadChars - " + ex.Message + vbCrLf + ex.StackTrace)
        End Try

        Return tVal.Trim
    End Function
    Public Function RemoveSingleQuotesV1(ByVal tVal$) As String
        Dim I As Integer = 0
        Dim CH$ = ""
        For I = 1 To Len(tVal)
            CH = Mid(tVal, I, 1)
    ...
    '''
    Public Function RemoveSingleQuotes(ByVal tVal$, ByVal isWeightedSearch As Boolean) As String
        Dim A$()
        Dim NewStr$ = ""
    ...
    Public Function RemoveUnwantedCharacters(ByVal tVal$) As String
        tVal = tVal.Trim
        Dim UCH$ = "()[]"
        Dim CH$
    ...
    Public Function RemoveCrLF(ByVal tVal$) As String
        tVal = tVal.Trim
        Dim CH$
        For i As Integer = 1 To tVal.Length
            CH = Mid(tVal, i, 1)
    ...
    Public Function ReplaceSingleQuotes(ByVal tStr$) As String
    ...
    Public Function ReplaceSingleQuotesV1(ByVal tVal$) As String
        Dim i As Integer = Len(tVal)
        Dim ch As String = ""
        For i = 1 To Len(tVal)
            ch = Mid(tVal, i, 1)
    ...
    Public Function RemoveOcrProblemChars(ByVal tVal$) As String
        Dim i As Integer = Len(tVal)
        Dim ch As String = ""
        For i = 1 To Len(tVal)
            ch = Mid(tVal, i, 1)
        ...
        Return tVal
    End Function
    Sub RemoveDoubleSlashes(ByRef FQN$)
        Dim i As Integer = 0
        Dim s1$ = ""
        Dim S2$ = ""
        Dim s$ = FQN
    ...
    Sub setConnectionStringTimeout(ByRef ConnStr$)
        ...
        ConnStr = NewConnStr$
    End Sub
    Sub setConnectionStringTimeout(ByRef ConnStr$, ByVal TimeOutSecs As String)
        ...
        ConnStr = NewConnStr$
    End Sub
    Function setNewTimeout(ByVal tgtStr$, ByVal StartingPoint As Integer, ByVal NewVal As String) As String
        Dim NextNumber$ = ""
        ...
        Try
            ...
            NewStr$ = S1 + " " + NewVal + " " + S2
        Catch ex As Exception
            WriteToArchiveLog("FindNextNumberInStr: " + ex.Message)
            NewStr$ = tgtStr$
        End Try
        Return NewStr$
    End Function
    Function setNewTimeout(ByVal tgtStr$, ByVal StartingPoint As Integer) As String
        Dim NextNumber$ = ""
        Dim NumberStartPos As Integer = 0
        Dim NumberEndPos As Integer = 0
        Dim NewStr$ = ""
    ...
    Public Function getFileSuffix(ByVal FQN$) As String
        ...
        Return suffix
    End Function
    Public Function substConnectionStringServer(ByVal ConnStr$, ByVal Server$) As String
        ...
        Return NewStr
    End Function
    Public Function getLicenseFromFile(ByVal CustomerID$, ByVal ServerName$, ByVal LicenseDirectory$) As String
        ...
        End Try
    End Function
    Public Function LoadLicenseFile(ByVal FQN$) As String
        ...
        Return strContents
    End Function
    Function ArchiveBitSet(ByVal FQN$) As Boolean
    ...
    End Function
    Sub setArchiveBitToNoArchNeeded(ByVal FQN$)
    ...
    End Sub
    Sub setArchiveBitFasle(ByVal FQN$)
    ...
    Function HashCalc(ByVal S$) As Double
    ...
    Function HashName(ByVal sName$) As Double
        Dim dHash As Double = 0
        dHash = HashCalc(sName)
        Return dHash
    End Function

    Function HashFqn(ByVal FQN$) As String
    ...
    Function HashDirName(ByVal DirName$) As String
    ...
    Function HashFileName(ByVal FileName$) As String
    ...
    Function HashDirFileName(ByVal DirName$, ByVal FileName$) As String
    ...
    Sub xSaveCurrentConnectionInfo()
        ...
        Dim oWrite As System.IO.StreamWriter = File.CreateText(FQN$)
    ...
    Overloads Function genEmailIdentifier(ByVal MessageSize As String, ByVal ReceivedTime As String, ByVal SenderEmailAddress As String, ByVal Subject As String, ByVal CurrentUserID As String) As String
    ...
    Function ConvertDate(ByVal tDate As Date) As String
        ...
        Catch ex As Exception
            ...
            WriteToSqlLog("ERRROR date: ConvertDate 100: LL= " + LL.ToString + ", error on converting date '" + tDate.ToString + "'." + vbCrLf + ex.Message)
        End Try
    ...
    Function getFileToArchive(ByVal DirToInventory As String, ByVal FileExt As List(Of String), ByVal ckArchiveBit As Boolean, ByVal InclSubDirs As Boolean) As String
        ...
        Try
            ...
            P.Close()
        Catch ex As Exception
            WriteToSqlLog("ERROR: getFileToArchive 100 - " + ex.Message)
        Finally
    ...
    Public Function GetFilesRecursive(ByVal initial As String, ByVal FilterList As List(Of String)) As List(Of FileInfo)
        ...
        Do While (stack.Count > 0)
            'frmNotify.lblFileSpec.Text = "Dir Inventory Remaining: " + stack.Count.ToString
            'frmNotify.Refresh()
    ...
    Sub GetFilesToArchive(ByRef iInventoryCnt As Integer, ByVal ckArchiveBit As Boolean, ByVal IncludeSubDir As Boolean, ByVal DirToInventory As String, ByVal FilterList As List(Of String), ByRef FilesToArchive As List(Of String))
        ...
        For Each fi In Files
            If iInventoryCnt Mod 100 = 0 Then
                'frmNotify.lblFileSpec.Text = "Cataloging File: " + iInventoryCnt.ToString + " of " + Files.Count.ToString
            End If
            ...
            MSG = ArchiveAttr & "|" & fi.Name & "|" & fi.Extension & "|" & fi.DirectoryName & "|" & fi.Length & "|" & fi.CreationTime & "|" & fi.LastWriteTime & "|" & fi.LastAccessTime
...
SkipIT:
    ...
    Public Overloads Function BlankOutSingleQuotes(ByVal sText As String) As String
        For i As Integer = 1 To sText.Length
            Dim CH As String = Mid(sText, i, 1)
            If CH.Equals("'") Then
                Mid(sText, i, 1) = " "
    ...
    Sub deleteDirectoryFile(ByVal DirFQN$)
        ...
        Try
            For Each FileName In System.IO.Directory.GetFiles(DirFQN$)
                ...
                Catch ex As System.Exception
                    WriteToSqlLog("ERROR 100 clsEmailFunctions:deleteDirectoryFile - failed to delete file '" + FileName + "'.")
                End Try
            Next FileName
        Catch ex As System.Exception
            WriteToSqlLog("ERROR 200 :deleteDirectoryFile - failed to delete from Dir '" + DirFQN$ + "'.")
        End Try
    ...
    Function TurnOffArchiveBit(ByVal filespec$) As Boolean
        ...
        Try
            ...
            'F = Nothing
        Catch ex As Exception
            Me.WriteToArchiveLog("Warning: TurnOffArchiveBit 100 - " + ex.Message)
            B = False
        End Try
    ...
    Function getImpersonateFileName(ByRef FQN As String) As Boolean
        ...
        Dim B As Boolean = True
        Dim tPath As String = getTempEnvironDir()
        ...
        If Not Directory.Exists(tPath) Then
            ...
            Catch ex As Exception
                MsgBox("Fatal ERROR: Failed to create the required directory, please ensure you have the required authority." + vbCrLf + ex.Message)
    ...
    End Function
    Public Overloads Function GetFileContents(ByVal FullPath As String,
