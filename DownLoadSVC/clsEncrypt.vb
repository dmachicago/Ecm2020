...
Public Class clsEncrypt
    ...
    Public Function DecryptTripleDES(ByVal sOut As String) As String
        ...
        Catch ex As Exception
            log.WriteToSqlLog("DecryptTripleDES - Error in decrypting string.")
        ...
        For i As Integer = 1 To UBound(AR)
            ...
            If i Mod 2 = 0 Then
                ...
                Catch ex As Exception
                    ...
                    log.WriteToSqlLog("clsEncrypt : xt001trc : 104 : " + ex.Message)
                End Try
    ...
    Public Function DecryptTripleDES128(ByVal sOut As String, ByRef B As Boolean) As String
        Try
            ...
            Return System.Text.ASCIIEncoding.ASCII.GetString(DESDecrypt.TransformFinalBlock(Buffer, 0, Buffer.Length))
        Catch ex As Exception
            log.WriteToSqlLog("clsEncrypt : DecryptTripleDES : 141 : " + ex.Message)
            Return ""
        End Try
    End Function
End Class
