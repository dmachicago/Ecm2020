...
{
    /// <summary>
    /// Processes the Exchange/Email records
    /// </summary>
    class EXCG
    {
        ...
        {
            int i = 0;
            string sql = "select  count(*) FROM Exchange where skey =  @skey ";
        ...
        /// <param name="ControlParms">The control parms.</param>
        /// <returns></returns>
        public static  bool SetVars(Dictionary<string, string> ControlParms)
        {
            bool b = true;
        ...
        public static  bool UpdateCol(SQLiteConnection conn, int RecKey, string ColName, DateTime ColVal)
        {
            ...
            try
            {
                ...
                {
                    string sql = "";
                    sql += "Update [Exchange] " + Environment.NewLine;
        ...
        public static  bool DeleteRec(SQLiteConnection conn, int RecKey)
        {
            ...
            try
            {
                ...
                {
                    string sql = "";
                    sql += "delete from [Exchange] " + Environment.NewLine;
                    sql += "WHERE RowID = @RowID ";
        ...
        public static  bool InsertRec(SQLiteConnection conn, Dictionary<string, string> ControlParms)
        {
            ...
            try
            {
                ...
                {
                    string sql = "";
                    sql += "INSERT INTO [Exchange] " + Environment.NewLine;
        ...
        /// <param name="ControlParms">The control parms.</param>
        /// <returns></returns>
        public static  List<DS_Exchange> GetRecords(SQLiteConnection conn, Dictionary<string, string> ControlParms)
        {
            List<DS_Exchange> ListOfDS = new List<DS_Exchange>();
            ...
            try
            {
                ...
                string sql = "SELECT RowID, KeyExists, skey from Exchange" + Environment.NewLine;
                sql += "where skey= @skey ";
                ...
                using (SQLiteCommand cmd = new SQLiteCommand(conn))
                {
                    ...
                    using (SQLiteDataReader reader = cmd.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            DS_Exchange dr = new DS_Exchange();
